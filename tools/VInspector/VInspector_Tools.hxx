...
public:
  ...
  //! \return text value
  Standard_EXPORT static AsciiString1 GetShapeTypeInfo(const TopAbs_ShapeEnum& theType);
  ...
  Standard_EXPORT static int SelectedOwners(const Handle(VisualContext)& theContext,
  ...
  Standard_EXPORT static bool IsOwnerSelected(const Handle(VisualContext)& theContext,
  ...
  Standard_EXPORT static QList<QVariant> GetInfo(Handle(VisualEntity)& theObject);
