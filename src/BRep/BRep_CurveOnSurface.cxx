...
void BRep_CurveOnSurface::D0(const Standard_Real U, Point3d& P) const
{
  // should be D0 NYI
...
void BRep_CurveOnSurface::Update()
{
  ...
  Standard_Boolean isneg = Precision1::IsNegativeInfinite(f);
  Standard_Boolean ispos = Precision1::IsPositiveInfinite(l);
  if (!isneg)
  {
    myPCurve->D0(f, myUV1);
  }
