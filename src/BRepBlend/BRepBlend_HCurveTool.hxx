...
public:
  ...
  static GeomAbs_Shape Continuity(const Handle(Curve5)& C);
  ...
  static Standard_Boolean IsClosed(const Handle(Curve5)& C);

  static Standard_Boolean IsPeriodic(const Handle(Curve5)& C);

  static Standard_Real Period(const Handle(Curve5)& C);
  ...
  static GeomAbs_CurveType GetType(const Handle(Curve5)& C);

  static gp_Lin Line(const Handle(Curve5)& C);

  static gp_Circ Circle(const Handle(Curve5)& C);

  static gp_Elips Ellipse(const Handle(Curve5)& C);

  static gp_Hypr Hyperbola(const Handle(Curve5)& C);

  static gp_Parab Parabola(const Handle(Curve5)& C);

  static Handle(BezierCurve3d) Bezier(const Handle(Curve5)& C);
