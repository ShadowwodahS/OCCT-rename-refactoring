...
BRepBlend_RstRstConstRad::BRepBlend_RstRstConstRad(const Handle(SurfaceAdaptor)& Surf1,
...
Standard_Boolean BRepBlend_RstRstConstRad::Value(const math_Vector& X, math_Vector& F)
{
...
Standard_Boolean BRepBlend_RstRstConstRad::Derivatives(const math_Vector& X, math_Matrix& D)
{
  Vector3d d11, d21;
...
void BRepBlend_RstRstConstRad::Set(const Handle(SurfaceAdaptor)& SurfRef1,
...
void BRepBlend_RstRstConstRad::Set(const Standard_Real First, const Standard_Real Last)
{
...
void BRepBlend_RstRstConstRad::GetTolerance(math_Vector& Tolerance, const Standard_Real Tol) const
{
...
void BRepBlend_RstRstConstRad::GetBounds(math_Vector& InfBound, math_Vector& SupBound) const
{
...
const Vector3d& BRepBlend_RstRstConstRad::TangentOnRst1() const
{
  if (istangent)
  {
...
const Vector3d& BRepBlend_RstRstConstRad::TangentOnRst2() const
{
  if (istangent)
  {
    throw Standard_DomainError();
                                                                ...
                                                                Vector3d&       VdMed) const
{
  ...
  Vector3d        vdmedNor; //,NRst1;    vdmedNor directong vector of the perpendicular bisector
  Standard_Real norm2;
                                       ...
                                       TColStd_Array1OfReal& Weights)
{
  ...
  ns  = Vector3d(Center, ptrst1).Normalized();
  ns2 = Vector3d(Center, ptrst2).Normalized();
  ...
  GeomFill1::GetCircle(myTConv, ns, ns2, nplan, ptrst1, ptrst2, Abs(ray), Center, Poles, Weights);
}
