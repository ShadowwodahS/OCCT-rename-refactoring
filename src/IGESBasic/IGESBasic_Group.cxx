...
void IGESBasic_Group::SetUser(const Standard_Integer type, const Standard_Integer form)
{
  if (type <= 5000)
...
Handle(IGESData_IGESEntity) IGESBasic_Group::Entity(const Standard_Integer Index) const
{
