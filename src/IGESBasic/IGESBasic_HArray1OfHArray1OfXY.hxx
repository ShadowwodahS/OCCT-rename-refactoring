...
class HArray1OfHArray1OfXY;
DEFINE_STANDARD_HANDLE(HArray1OfHArray1OfXY, RefObject)

class HArray1OfHArray1OfXY : public RefObject
{

public:
  Standard_EXPORT HArray1OfHArray1OfXY(const Standard_Integer low,
