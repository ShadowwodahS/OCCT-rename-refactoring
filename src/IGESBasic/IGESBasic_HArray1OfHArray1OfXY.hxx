...
DEFINE_STANDARD_HANDLE(IGESBasic_HArray1OfHArray1OfXY, RefObject)

class IGESBasic_HArray1OfHArray1OfXY : public RefObject
{
...
public:
  ...
  DEFINE_STANDARD_RTTI_INLINE(IGESBasic_HArray1OfHArray1OfXY, RefObject)
