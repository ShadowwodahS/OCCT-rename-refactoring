...
//! Defines basic File Access Module for IGESBasic1 (specific parts)
...
public:
  ...
  //! Defines Case Numbers1 for Entities of IGESBasic1
  ...
  //! Reads own parameters from file for an Entity of IGESBasic1
