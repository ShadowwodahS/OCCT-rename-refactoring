...
DEFINE_STANDARD_HANDLE(IGESBasic_HArray1OfHArray1OfInteger, RefObject)

class IGESBasic_HArray1OfHArray1OfInteger : public RefObject
{
...
public:
  ...
  DEFINE_STANDARD_RTTI_INLINE(IGESBasic_HArray1OfHArray1OfInteger, RefObject)
