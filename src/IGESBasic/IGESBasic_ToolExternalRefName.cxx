...
ExternalRefNameTool::ExternalRefNameTool() {}

void ExternalRefNameTool::ReadOwnParams(const Handle(IGESBasic_ExternalRefName)& ent,
...
void ExternalRefNameTool::WriteOwnParams(const Handle(IGESBasic_ExternalRefName)& ent,
                                                   IGESData_IGESWriter& IW) const
{
  IW.Send(ent->ReferenceName());
}

void ExternalRefNameTool::OwnShared(const Handle(IGESBasic_ExternalRefName)& /* ent */,
                                              Interface_EntityIterator& /* iter */) const
{
}

void ExternalRefNameTool::OwnCopy(const Handle(IGESBasic_ExternalRefName)& another,
...
DirectoryChecker ExternalRefNameTool::DirChecker(
  const Handle(IGESBasic_ExternalRefName)& /* ent */) const
{
  DirectoryChecker DC(416, 3);
...
void ExternalRefNameTool::OwnCheck(const Handle(IGESBasic_ExternalRefName)& /* ent */,
                                             const Interface_ShareTool&,
                                             Handle(Interface_Check)& /* ach */) const
{
}

void ExternalRefNameTool::OwnDump(const Handle(IGESBasic_ExternalRefName)& ent,
