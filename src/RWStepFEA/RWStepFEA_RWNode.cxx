...
void RWStepFEA_RWNode::WriteStep(StepData_StepWriter& SW, const Handle(StepFEA_Node)& ent) const
{
...
void RWStepFEA_RWNode::Share(const Handle(StepFEA_Node)& ent, Interface_EntityIterator& iter) const
{
