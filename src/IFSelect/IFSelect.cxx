...
Standard_Boolean IFSelect1::SaveSession(const Handle(IFSelect_WorkSession)& WS,
...
Standard_Boolean IFSelect1::RestoreSession(const Handle(IFSelect_WorkSession)& WS,
                                          const Standard_CString              file)
{
