...
//! Definition of General Services for IGESGeom1 (specific part)
//! This Services comprise : Shared & Implied Lists, Copy, Check
class IGESGeom_GeneralModule : public IGESData_GeneralModule
{

public:
  //! Creates a GeneralModule from IGESGeom1 and puts it into GeneralLib
  ...
  //! Flash;  Point with a symbol;  Plane1 with a symbol
