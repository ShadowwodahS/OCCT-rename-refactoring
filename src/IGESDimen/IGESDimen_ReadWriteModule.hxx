...
//! Defines Dimen File Access Module for IGESDimen1 (specific parts)
...
public:
  ...
  //! Defines Case Numbers1 for Entities of IGESDimen1
  ...
  //! Reads own parameters from file for an Entity of IGESDimen1
