...
//! with call to MessageFile::LoadFile().
//!
...
//!
//! Message1 can be set explicitly for the status; in this case the
...
//! By default, Message1::DefaultMessenger() is used.
...
public:
  ...
  Standard_EXPORT virtual void SendStatusMessages(
    const ExecutionStatus& theFilter,
  ...
  //! set in theStatus
  Standard_EXPORT void AddStatus(const ExecutionStatus&        theStatus,
