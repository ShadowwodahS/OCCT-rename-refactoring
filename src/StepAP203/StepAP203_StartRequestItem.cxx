...
Standard_Integer StepAP203_StartRequestItem::CaseNum(const Handle(RefObject)& ent) const
{
  if (ent.IsNull())
    return 0;
...
Handle(StepBasic_ProductDefinitionFormation) StepAP203_StartRequestItem::
