...
Handle(HArray1OfContractedItem) StepAP203_CcDesignContract::Items() const
{
  return theItems;
}
...
void StepAP203_CcDesignContract::SetItems(const Handle(HArray1OfContractedItem)& aItems)
{
  theItems = aItems;
}
