...
void V3d_Plane::Display(const Handle(ViewWindow)& theView, const Color1& theColor)
{
...
void V3d_Plane::Update()
{
  ...
  aTransform.SetTransformation(aGeomPln.Position1());
  aTransform.Invert();
  myGraphicStructure->SetTransformation(new Datum3D2(aTransform));
}
