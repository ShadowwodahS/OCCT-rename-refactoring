...
public:
  ...
  //! @return text aspect
  const Handle(Prs3d_TextAspect)& LabelAspect(V3d_TypeOfAxe theAxis) const
  {
  ...
  const Handle(Prs3d_ShadingAspect)& ArrowAspect(V3d_TypeOfAxe theAxis) const
  {
...
protected:
  ...
  void invalidate() { myToCompute = Standard_True; }
