...
public:
  ...
  //! is passed.
  Standard_EXPORT void SetAutoZFitMode(const Standard_Boolean theIsOn,
...
public:
  ...
  {
    SetImageBasedLighting(Standard_True, theToUpdate);
  }
...
public:
  ...
  Standard_EXPORT void Rotate(const Standard_Real    Angle,
                              const Standard_Boolean Start = Standard_True);

  //! Movement of the eye parallel to the coordinate system
  //! of reference of the screen a distance relative to the
  //! initial position expressed by Start = Standard_True.
  Standard_EXPORT void Move(const Standard_Real    Dx,
  ...
  //! Start = Standard_True.
  Standard_EXPORT void Move(const V3d_TypeOfAxe    Axe,
  ...
  Standard_EXPORT void Move(const Standard_Real    Length,
                            const Standard_Boolean Start = Standard_True);
  ...
  //! Start = Standard_True
  Standard_EXPORT void Translate(const Standard_Real    Dx,
                                 const Standard_Real    Dy,
                                 const Standard_Real    Dz,
                                 const Standard_Boolean Start = Standard_True);
  ...
  //! position expressed by Start = Standard_True
  Standard_EXPORT void Translate(const Standard_Real    Length,
                                 const Standard_Boolean Start = Standard_True);

  //! places the point of the view corresponding
  //! at the pixel position x,y at the center of the window
  //! and updates the view.
  Standard_EXPORT void Place(const Standard_Integer theXp,
  ...
  //! Start = Standard_True
  Standard_EXPORT void Turn(const Standard_Real    Ax,
                            const Standard_Real    Ay,
                            const Standard_Real    Az,
                            const Standard_Boolean Start = Standard_True);
  ...
  //! Start = Standard_True
  Standard_EXPORT void Turn(const V3d_TypeOfAxe    Axe,
                            const Standard_Real    Angle,
                            const Standard_Boolean Start = Standard_True);
  ...
  //! position expressed by Start = Standard_True
  Standard_EXPORT void Turn(const Standard_Real    Angle,
                            const Standard_Boolean Start = Standard_True);
  ...
  Standard_EXPORT void SetProj(const Standard_Real Vx,
                               const Standard_Real Vy,
                               const Standard_Real Vz);
  ...
  Standard_EXPORT void SetUp(const Standard_Real Vx,
                             const Standard_Real Vy,
                             const Standard_Real Vz);
  ...
  Standard_EXPORT void Panning(const Standard_Real    theDXv,
  ...
  //! Updates the view.
  Standard_EXPORT void SetZoom(const Standard_Real    Coef,
                               const Standard_Boolean Start = Standard_True);
  ...
  //! || 0   0   0   1 ||
  //! Updates the view.
  Standard_EXPORT void SetAxialScale(const Standard_Real Sx,
  ...
  Standard_EXPORT void FitAll(const Standard_Real    theMargin   = 0.01,
  ...
  Standard_EXPORT void DepthFitAll(const Standard_Real Aspect = 0.01,
  ...
  Standard_EXPORT void FitAll(const Standard_Real theMinXv,
  ...
  Standard_EXPORT void WindowFit(const Standard_Integer theMinXp,
  ...
  Standard_EXPORT void Convert(const Standard_Integer Xp,
  ...
  Standard_EXPORT void Convert(const Standard_Real Xv,
  ...
  Standard_EXPORT void ConvertToGrid(const Standard_Integer Xp,
                                     const Standard_Integer Yp,
                                     Standard_Real&         Xg,
                                     Standard_Real&         Yg,
  ...
  Standard_EXPORT void ConvertToGrid(const Standard_Real X,
                                     const Standard_Real Y,
                                     const Standard_Real Z,
                                     Standard_Real&      Xg,
                                     Standard_Real&      Yg,
  ...
  Standard_EXPORT void Convert(const Standard_Real X,
                               const Standard_Real Y,
                               const Standard_Real Z,
                               Standard_Integer&   Xp,
                               Standard_Integer&   Yp) const;
  ...
  Standard_EXPORT void ProjReferenceAxe(const Standard_Integer Xpix,
  ...
  //! Performs update of view.
  Standard_EXPORT void Pan(const Standard_Integer theDXp,
  ...
  Standard_EXPORT void Zoom(const Standard_Integer theXp1,
  ...
  Standard_EXPORT void ZoomAtPoint(const Standard_Integer theMouseStartX,
  ...
  //! idem than WindowFit
  void WindowFitAll(const Standard_Integer Xmin,
  ...
  Standard_EXPORT Standard_Boolean
    Dump(const Standard_CString      theFile,
...
private:
  ...
  Standard_EXPORT Standard_Integer MinMax(Standard_Real& Umin,
                                          Standard_Real& Vmin,
                                          Standard_Real& Umax,
  ...
  Standard_EXPORT Standard_Integer MinMax(Standard_Real& Xmin,
                                          Standard_Real& Ymin,
                                          Standard_Real& Zmin,
                                          Standard_Real& Xmax,
                                          Standard_Real& Ymax,
