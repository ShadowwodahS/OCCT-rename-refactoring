...
DEFINE_STANDARD_HANDLE(StepRepr_RepresentationContext, RefObject)

class StepRepr_RepresentationContext : public RefObject
{
...
public:
  ...
  DEFINE_STANDARD_RTTIEXT(StepRepr_RepresentationContext, RefObject)
