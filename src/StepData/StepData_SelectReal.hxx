...
DEFINE_STANDARD_HANDLE(StepData_SelectReal, SelectMember)
...
class StepData_SelectReal : public SelectMember
{
...
public:
  ...
  DEFINE_STANDARD_RTTIEXT(StepData_SelectReal, SelectMember)
