...
public:
  ...
  //! Destructor.
  Standard_EXPORT virtual ~SelectingVolumeManager();
...
public:
  ...
  virtual void GetPlanes(
    NCollection_Vector<NCollection_Vec4<Standard_Real>>& thePlaneEquations) const = 0;
...
public:
  ...
  Standard_Boolean Overlaps(const Point3d& thePnt, PickResult& thePickResult) const
  {
