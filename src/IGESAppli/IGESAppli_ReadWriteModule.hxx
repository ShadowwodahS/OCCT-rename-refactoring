...
//! Defines basic File Access Module for IGESAppli1 (specific parts)
...
public:
  ...
  //! Defines Case Numbers1 for Entities of IGESAppli1
  ...
  //! Reads own parameters from file for an Entity of IGESAppli1
