...
LevelFunctionTool::LevelFunctionTool() {}

void LevelFunctionTool::ReadOwnParams(const Handle(IGESAppli_LevelFunction)& ent,
...
void LevelFunctionTool::WriteOwnParams(const Handle(IGESAppli_LevelFunction)& ent,
...
void LevelFunctionTool::OwnShared(const Handle(IGESAppli_LevelFunction)& /* ent */,
                                            Interface_EntityIterator& /* iter */) const
{
}

void LevelFunctionTool::OwnCopy(const Handle(IGESAppli_LevelFunction)& another,
...
Standard_Boolean LevelFunctionTool::OwnCorrect(
...
DirectoryChecker LevelFunctionTool::DirChecker(
  const Handle(IGESAppli_LevelFunction)& /* ent */) const
{
  DirectoryChecker DC(406, 3); // Form no = 3 & Type = 406
...
void LevelFunctionTool::OwnCheck(const Handle(IGESAppli_LevelFunction)& ent,
...
void LevelFunctionTool::OwnDump(const Handle(IGESAppli_LevelFunction)& ent,
