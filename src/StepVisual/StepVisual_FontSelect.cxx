...
Standard_Integer StepVisual_FontSelect::CaseNum(const Handle(RefObject)& ent) const
{
  if (ent.IsNull())
    return 0;
...
Handle(StepVisual_ExternallyDefinedTextFont) StepVisual_FontSelect::ExternallyDefinedTextFont()
  const
{
