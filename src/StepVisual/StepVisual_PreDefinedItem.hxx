...
DEFINE_STANDARD_HANDLE(StepVisual_PreDefinedItem, RefObject)

class StepVisual_PreDefinedItem : public RefObject
{
...
public:
  ...
  DEFINE_STANDARD_RTTIEXT(StepVisual_PreDefinedItem, RefObject)
