...
IMPLEMENT_STANDARD_RTTIEXT(StepVisual_AreaInSet, RefObject)
...
void StepVisual_AreaInSet::SetInSet(const Handle(PresentationSet1)& aInSet)
{
  inSet = aInSet;
}

Handle(PresentationSet1) StepVisual_AreaInSet::InSet() const
{
  return inSet;
}
