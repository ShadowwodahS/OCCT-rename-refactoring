...

{
  ...
  Standard_Boolean infinite = Precision1::IsInfinite(u11) && Precision1::IsInfinite(u12)
                              && Precision1::IsInfinite(u21) && Precision1::IsInfinite(u22);
  ...
  if (myIsDone && !myExtCC.IsParallel())
  {
    ...
    if (myTotalDist <= Precision1::Confusion())
      return;
  }
