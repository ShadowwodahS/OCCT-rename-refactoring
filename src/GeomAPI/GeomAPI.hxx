...
public:
  ...
  Standard_EXPORT static Handle(GeomCurve2d) To2d(const Handle(GeomCurve3d)& C, const gp_Pln& P);
  ...
  Standard_EXPORT static Handle(GeomCurve3d) To3d(const Handle(GeomCurve2d)& C, const gp_Pln& P);
};
