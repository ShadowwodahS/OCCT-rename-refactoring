...
public:
  struct LoadingStatistic
  {
    ...
    Standard_EXPORT void PrintStatistic(const AsciiString1& thePrefix = "") const;
  ...
  void SetFileName(const AsciiString1& theFileName) { myFileName = theFileName; }
  ...
  void PrintStatistic() const
  {
    if (myLoadingStatistic)
    {
      myLoadingStatistic->PrintStatistic(AsciiString1("[Mesh1 reader. File '")
                                         + myFileName + "']. ");
    }
  }
...
protected: //! @name interface for filling triangulation data
  ...
  virtual bool setNbPositionNodes(const Handle(MeshTriangulation)& theMesh,
  ...
  virtual void setNodePosition(const Handle(MeshTriangulation)& theMesh,
  ...
  //! @param[in] theNbNodes  nodes number
  //! @return TRUE in case of success operation
  virtual bool setNbUVNodes(const Handle(MeshTriangulation)& theMesh,
  ...
  virtual void setNodeUV(const Handle(MeshTriangulation)& theMesh,
                         Standard_Integer                  theIndex,
  ...
  //! @param[in] theNbNodes  nodes number
  //! @return TRUE in case of success operation
  virtual bool setNbNormalNodes(const Handle(MeshTriangulation)& theMesh,
                                Standard_Integer                  theNbNodes) const
  {
    if (theNbNodes <= 0 || theMesh->NbNodes() != theNbNodes)
    {
  ...
  virtual void setNodeNormal(const Handle(MeshTriangulation)& theMesh,
                             Standard_Integer                  theIndex,
  ...
  //! @return TRUE in case of success operation
  virtual bool setNbTriangles(const Handle(MeshTriangulation)& theMesh,
  ...
  //! @return TRUE in case of success operation
  Standard_EXPORT virtual bool setNbEdges(const Handle(MeshTriangulation)& theMesh,
  ...
  //! @return 0 if node indexes are out of range,
  //!         1 in case of success operation.
  Standard_EXPORT virtual Standard_Integer setEdge(const Handle(MeshTriangulation)& theMesh,
