...
{
  AsciiString1    Name;      //!< name for the user
  AsciiString1    RawName;   //!< name within low-level format structure
  Handle(TDataStd_NamedData) NamedData; //!< optional metadata
  XCAFPrs_Style              Style;     //!< presentation style
};

typedef NCollection_DataMap<TopoShape, RWMesh_NodeAttributes, ShapeHasher>
