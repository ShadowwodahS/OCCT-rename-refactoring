...
public:
  ...
  Standard_EXPORT Standard_Boolean UOscSurf(const Standard_Real          U,
  ...
  Standard_EXPORT Standard_Boolean VOscSurf(const Standard_Real          U,
                                            const Standard_Real          V,
                                            Standard_Boolean&            t,
                                            Handle(Geom_BSplineSurface)& L) const;
...
private:
  ...
  Standard_EXPORT Standard_Boolean BuildOsculatingSurface(const Standard_Real                Param,
