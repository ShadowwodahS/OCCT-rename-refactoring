...
public:
  ...
  Standard_EXPORT Geom_Axis1Placement(const Axis3d& A1);

  //! P is the origin of the axis placement and V is the direction
  //! of the axis placement.
  Standard_EXPORT Geom_Axis1Placement(const Point3d& P, const Dir3d& V);

  //! Returns a non transient copy of <me>.
  Standard_EXPORT const Axis3d& Ax1() const;
