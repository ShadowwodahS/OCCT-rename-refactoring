...
//! - the poles table, which is an array of Point3d points, and
...
//! is less than or equal to gp1::Resolution(). We
...
public:
  ...
  //! or one weight value is lower or equal to Resolution from package gp1.
  Standard_EXPORT BezierCurve3d(const TColgp_Array1OfPnt&   CurvePoles,
  ...
  //! MaxDegree + 1.
  Standard_EXPORT void InsertPoleAfter(const Standard_Integer Index, const Point3d& P);
  ...
  //! Raised if the resulting number of poles is greater than
  //! MaxDegree + 1.
  //! Raised if Weight is lower or equal to Resolution from package gp1.
  ...
  //! Raised if the resulting number of poles is greater than
  //! MaxDegree + 1.
  Standard_EXPORT void InsertPoleBefore(const Standard_Integer Index, const Point3d& P);
