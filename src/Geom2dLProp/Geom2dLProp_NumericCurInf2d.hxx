...
class NumericCurveInfo2d
{
public:
  DEFINE_STANDARD_ALLOC

  Standard_EXPORT NumericCurveInfo2d();

  //! Computes the locals extremas of curvature.
  Standard_EXPORT void PerformCurExt(const Handle(GeomCurve2d)& C, CurveAndInfo& Result);

  //! Computes the inflections.
  Standard_EXPORT void PerformInf(const Handle(GeomCurve2d)& C, CurveAndInfo& Result);
