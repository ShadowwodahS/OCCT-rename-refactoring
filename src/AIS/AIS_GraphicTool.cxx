...
Standard_Real GraphicTool::GetLineWidth(const Handle(StyleDrawer)& Dr,
                                            const AIS_TypeOfAttribute   Att)
{
...
Aspect_TypeOfLine GraphicTool::GetLineType(const Handle(StyleDrawer)& Dr,
                                               const AIS_TypeOfAttribute   Att)
{
  Handle(Prs3d_LineAspect) LA = GetLineAspect(Dr, Att);
...
void GraphicTool::GetLineAtt(const Handle(StyleDrawer)& Dr,
                                 const AIS_TypeOfAttribute   Att,
...
Graphic3d_MaterialAspect GraphicTool::GetMaterial(const Handle(StyleDrawer)& Dr)
{
