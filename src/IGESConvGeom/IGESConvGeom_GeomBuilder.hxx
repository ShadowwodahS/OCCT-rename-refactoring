...
public:
  ...
  //! Returns the Position1 in which the method EvalXYZ will
  //! evaluate a XYZ. It can be regarded as defining a local system.
  //! It is initially set to Identity
  Standard_EXPORT Transform3d Position1() const;
  ...
  //! Position1. Even if it is an Identity : IsIdentity should be
  //! tested first.
