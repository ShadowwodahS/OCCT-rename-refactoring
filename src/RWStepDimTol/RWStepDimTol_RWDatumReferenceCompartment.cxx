...
void RWStepDimTol_RWDatumReferenceCompartment::ReadStep(
...
void RWStepDimTol_RWDatumReferenceCompartment::WriteStep(
    ...
    for (i = 1; i <= nb; i++)
    {
      ...
      switch (aType)
      {
        case 1:
          ...
          break;
        case 2:
          SW.Send(aModifier.SimpleDatumReferenceModifierMember());
          break;
      }
    }
    SW.CloseSub();
...
void RWStepDimTol_RWDatumReferenceCompartment::Share(
  const Handle(StepDimTol_DatumReferenceCompartment)& ent,
