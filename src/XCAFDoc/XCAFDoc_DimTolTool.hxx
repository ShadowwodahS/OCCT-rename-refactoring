...
public:
  ...
  Standard_EXPORT static Handle(XCAFDoc_DimTolTool) Set(const DataLabel& L);
  ...
  Standard_EXPORT Standard_Boolean IsDimension(const DataLabel& theLab) const;
  ...
  Standard_EXPORT void SetDimension(const TDF_LabelSequence& theFirstLS,
                                    ...
                                    const DataLabel&         theDimL) const;

  //! Sets a dimension to target labels.
  Standard_EXPORT void SetDimension(const DataLabel& theFirstL,
                                    const DataLabel& theSecondL,
                                    const DataLabel& theDimL) const;

  //! Sets a dimension to the target label.
  Standard_EXPORT void SetDimension(const DataLabel& theL, const DataLabel& theDimL) const;

  //! Returns all Dimension labels defined for theShapeL.
  Standard_EXPORT Standard_Boolean GetRefDimensionLabels(const DataLabel&   theShapeL,
                                                         TDF_LabelSequence& theDimensions) const;

  //! Adds a dimension definition to the GD&T table and returns its label.
  Standard_EXPORT DataLabel AddDimension();

  //! Returns True if the label belongs to the GD&T table and is a dimension tolerance.
  Standard_EXPORT Standard_Boolean IsGeomTolerance(const DataLabel& theLab) const;
  ...
  Standard_EXPORT void SetGeomTolerance(const DataLabel& theL, const DataLabel& theGeomTolL) const;
  ...
  Standard_EXPORT Standard_Boolean GetRefGeomToleranceLabels(const DataLabel&   theShapeL,
                                                             TDF_LabelSequence& theDimTols) const;

  //! Adds a GeomTolerance definition to the GD&T table and returns its label.
  Standard_EXPORT DataLabel AddGeomTolerance();

  //! Returns True if theLab belongs to the GD&T table and is a dmension tolerance.
  Standard_EXPORT Standard_Boolean IsDimTol(const DataLabel& theLab) const;
  ...
  Standard_EXPORT Standard_Boolean
    FindDimTol(const Standard_Integer                  theKind,
  ...
  Standard_EXPORT DataLabel AddDimTol(const Standard_Integer                  theKind,
                                      const Handle(TColStd_HArray1OfReal)&    theVal,
                                      const Handle(TCollection_HAsciiString)& theName,
                                      const Handle(TCollection_HAsciiString)& theDescription) const;

  //! Sets existing dimension tolerance to theL label.
  Standard_EXPORT void SetDimTol(const DataLabel& theL, const DataLabel& theDimTolL) const;

  //! Creates a dimension tolerance and sets it to theL label.
  Standard_EXPORT DataLabel SetDimTol(const DataLabel&                        theL,
  ...
  Standard_EXPORT static Standard_Boolean GetRefShapeLabel(const DataLabel&   theL,
  ...
  Standard_EXPORT Standard_Boolean
    GetDimTol(const DataLabel&                  theDimTolL,
  ...
  Standard_EXPORT Standard_Boolean IsDatum(const DataLabel& lab) const;
  ...
  Standard_EXPORT Standard_Boolean
    FindDatum(const Handle(TCollection_HAsciiString)& theName,
              const Handle(TCollection_HAsciiString)& theDescription,
