...
private:
                                                    ...
                                                    const Coords2d& /*theMidPoint*/)
  {
    ...
    if ((GeomLib1::NormEstim(aSurf, theNodeInfo1.Point2d, Precision1::Confusion(), aNorm1) == 0)
        && (GeomLib1::NormEstim(aSurf, theNodeInfo2.Point2d, Precision1::Confusion(), aNorm2) == 0))
    {
...
#if 0
    else if (GeomLib1::NormEstim(aSurf, theMidPoint, Precision1::Confusion(), aNorm1) != 0)
    {
