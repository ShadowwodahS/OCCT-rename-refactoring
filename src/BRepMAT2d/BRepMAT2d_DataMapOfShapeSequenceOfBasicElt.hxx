...
typedef NCollection_DataMap<TopoShape, MAT_SequenceOfBasicElt, ShapeHasher>
  BRepMAT2d_DataMapOfShapeSequenceOfBasicElt;
typedef NCollection_DataMap<TopoShape, MAT_SequenceOfBasicElt, ShapeHasher>::Iterator
