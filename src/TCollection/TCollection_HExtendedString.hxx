...
public:
  ...
  Standard_EXPORT TCollection_HExtendedString(const Standard_Integer      length,
  ...
  Standard_EXPORT Standard_Integer
    SearchFromEnd(const Handle(TCollection_HExtendedString)& what) const;

  //! Returns pointer to ExtString
  Standard_ExtString ToExtString() const { return myString.ToExtString(); }
  ...
  Standard_EXPORT Handle(TCollection_HExtendedString) Token(
