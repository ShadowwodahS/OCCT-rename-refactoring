...
public:
  ...
  Standard_EXPORT HatchGen_Domain(const PointOnHatching& P1,
  ...
  Standard_EXPORT HatchGen_Domain(const PointOnHatching& P, const Standard_Boolean First);

  //! Sets the first and the second points of the domain.
  void SetPoints(const PointOnHatching& P1, const PointOnHatching& P2);
  ...
  void SetFirstPoint(const PointOnHatching& P);
  ...
  void SetSecondPoint(const PointOnHatching& P);
  ...
  const PointOnHatching& FirstPoint() const;
  ...
  const PointOnHatching& SecondPoint() const;
...
private:
  ...
  PointOnHatching myFirstPoint;
  Standard_Boolean         myHasSecondPoint;
  PointOnHatching mySecondPoint;
};
