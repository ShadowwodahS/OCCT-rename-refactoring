...
protected:
  ...
  {
    const Standard_Real aDX = thePrmArr[1] - thePrmArr[0], aDY = thePrmArr[3] - thePrmArr[2],
...
//=======================================================================
static inline void SetMinMax(Standard_Real* const thePrmArr, const Standard_Real theNewParam)
{
...
OBBTool::OBBTool(const TColgp_Array1OfPnt&   theL,
                      ...
                      const Standard_Boolean      theIsOptimal)
{
  switch (theListOfPoints.Length())
  {
    case 1:
      ...
      return;
    case 2: {
      const Standard_Real aTol1 = (theListOfTolerances == 0) ? 0.0 : theListOfTolerances->First();
