...
public:
  ...
  Standard_NODISCARD Standard_EXPORT Box2f Transformed(const gp_Trsf2d& theTrsf) const;
  ...
  Standard_EXPORT Standard_Boolean IsIn(const Box2f& theBox, const gp_Trsf2d& theTrsf) const;
