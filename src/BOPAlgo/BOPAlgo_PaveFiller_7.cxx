...
static Standard_Boolean IsBasedOnPlane(const TopoDS_Face& aF);
...
public:
  ...
  const Handle(Geom2d_Curve)& GetNewPCurve() const { return myNewC2d; }
...
public:
  ...
  const Handle(Geom2d_Curve)& GetCurve2d() const { return myCurve; }
