...
typedef NCollection_DataMap<Standard_Integer, Handle(IntegerSequenceArray)>
  MeshVS_DataMapOfHArray1OfSequenceOfInteger;
typedef NCollection_DataMap<Standard_Integer, Handle(IntegerSequenceArray)>::Iterator
