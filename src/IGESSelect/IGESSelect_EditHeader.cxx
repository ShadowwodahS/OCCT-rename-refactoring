                                             ...
                                             const Handle(Interface_InterfaceModel)& model) const
{
  ...
  form->LoadValue(
    26,
    new TCollection_HAsciiString(IGESData_BasicEditor::IGESVersionName(GS.IGESVersion())));
  form->LoadValue(27, new TCollection_HAsciiString(GS.DraftingStandard()));
  form->LoadValue(
    28,
    new TCollection_HAsciiString(IGESData_BasicEditor::DraftingName(GS.DraftingStandard())));
