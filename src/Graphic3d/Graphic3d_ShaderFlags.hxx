...
enum Graphic3d_ShaderFlags
{
  ...
  Graphic3d_ShaderFlags_TextureNormal =
    ...
    | Graphic3d_ShaderFlags_TextureEnv,       //!< extended texture set (with normal map)
  ...
  Graphic3d_ShaderFlags_PointSpriteA =
    ...
    | Graphic3d_ShaderFlags_PointSprite,      //!< point sprite with Alpha image
  ...
  Graphic3d_ShaderFlags_ClipPlanesN =
    ...
    | Graphic3d_ShaderFlags_ClipPlanes2,     //!< handle N clipping planes
  ...
  Graphic3d_ShaderFlags_AlphaTest =
    0x0400, //!< discard fragment by alpha test (defined by cutoff value)
