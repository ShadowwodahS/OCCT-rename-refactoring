...
void RWStepVisual_RWTemplate::ReadStep(const Handle(StepData_StepReaderData)& data,
                                       const Standard_Integer                 num,
                                       Handle(Interface_Check)&               ach,
                                       const Handle(StepVisual_Template)&     ent) const
{
...
void RWStepVisual_RWTemplate::Share(const Handle(StepVisual_Template)& ent,
