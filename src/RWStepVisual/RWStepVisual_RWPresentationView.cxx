...
void RWStepVisual_RWPresentationView::ReadStep(const Handle(StepData_StepReaderData)&     data,
                                               ...
                                               const Handle(StepVisual_PresentationView)& ent) const
{
  ...
  if (!data->CheckNbParams(num, 3, ach, "presentation_view has not 3 parameter(s)"))
    return;
...
void RWStepVisual_RWPresentationView::Share(const Handle(StepVisual_PresentationView)& ent,
