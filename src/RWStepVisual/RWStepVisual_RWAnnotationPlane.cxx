...
void RWStepVisual_RWAnnotationPlane::ReadStep(const Handle(StepData_StepReaderData)&    data,
...
void RWStepVisual_RWAnnotationPlane::Share(const Handle(StepVisual_AnnotationPlane)& ent,
