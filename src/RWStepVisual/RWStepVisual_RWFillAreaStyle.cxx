...
void RWStepVisual_RWFillAreaStyle::ReadStep(const Handle(StepData_StepReaderData)&  data,
...
void RWStepVisual_RWFillAreaStyle::Share(const Handle(StepVisual_FillAreaStyle)& ent,
