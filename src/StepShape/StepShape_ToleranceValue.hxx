...
public:
  ...
  Standard_EXPORT Handle(RefObject) LowerBound() const;

  Standard_EXPORT void SetLowerBound(const Handle(RefObject)& lower_bound);

  Standard_EXPORT Handle(RefObject) UpperBound() const;
...
protected:
private:
  Handle(RefObject) theLowerBound;
  Handle(RefObject) theUpperBound;
};
