...
void IntTools_TopolTool::ComputeSamplePoints()
{
  ...
  isbiguinf = Precision1::IsNegativeInfinite(uinf);
  isbigusup = Precision1::IsPositiveInfinite(usup);
  isbigvinf = Precision1::IsNegativeInfinite(vinf);
  isbigvsup = Precision1::IsPositiveInfinite(vsup);
  ...
  switch (typS)
  {
    ...
    case GeomAbs_Cylinder: {
      ...
      if (aMaxAngle > Precision1::Angular())
      {
    ...
    case GeomAbs_Cone: {
      ...
      gp_Circ aCircle =
        ElSLib1::ConeVIso(aCone.Position1(), aCone.RefRadius(), aCone.SemiAngle(), vinf);
      Standard_Real aRadius = aCircle.Radius();
      aCircle = ElSLib1::ConeVIso(aCone.Position1(), aCone.RefRadius(), aCone.SemiAngle(), vsup);
    ...
    case GeomAbs_Torus: {
      ...
      if (typS == GeomAbs_Torus)
      {
        ...
        aCircle =
          ElSLib1::TorusUIso(aTorus.Position1(), aTorus.MajorRadius(), aTorus.MinorRadius(), uinf);
        aRadius2 = aCircle.Radius();
        aCircle =
          ElSLib1::TorusUIso(aTorus.Position1(), aTorus.MajorRadius(), aTorus.MinorRadius(), usup);
        aRadius2 = (aRadius2 < aCircle.Radius()) ? aCircle.Radius() : aRadius2;

        aCircle =
          ElSLib1::TorusVIso(aTorus.Position1(), aTorus.MajorRadius(), aTorus.MinorRadius(), vinf);
        aRadius1 = aCircle.Radius();
        aCircle =
          ElSLib1::TorusVIso(aTorus.Position1(), aTorus.MajorRadius(), aTorus.MinorRadius(), vsup);
