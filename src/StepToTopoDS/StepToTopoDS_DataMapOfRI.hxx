...
typedef NCollection_DataMap<Handle(StepRepr_RepresentationItem), TopoShape>
  StepToTopoDS_DataMapOfRI;
typedef NCollection_DataMap<Handle(StepRepr_RepresentationItem), TopoShape>::Iterator
