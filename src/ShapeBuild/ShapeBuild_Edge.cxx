...
void ShapeBuild_Edge::RemovePCurve(const TopoDS_Edge& edge, const Handle(Geom_Surface)& surf) const
{
...
static Standard_Integer CountPCurves(const TopoDS_Edge& edge, const TopoDS_Face& face)
{
  TopLoc_Location      L;
