...
//*******************************************************
GeomFill_FunctionDraft::GeomFill_FunctionDraft(const Handle(SurfaceAdaptor)& S,
...
//*******************************************************
Standard_Boolean GeomFill_FunctionDraft::DerivT(const Handle(Curve5)& C,
...
//*******************************************************
Standard_Boolean GeomFill_FunctionDraft::Deriv2T(const Handle(Curve5)& C,
                                                 const Standard_Real            Param,
                                                 const Standard_Real            W,
                                                 const Vector3d&                  d2N,
                                                 const Standard_Real            teta,
...
//*******************************************************
Standard_Boolean GeomFill_FunctionDraft::DerivTX(const Vector3d&       dN,
                                                 const Standard_Real teta,
                                                 math_Matrix&        D)
{
  //  Point3d P;
