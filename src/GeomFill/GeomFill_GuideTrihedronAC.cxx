                                               ...
                                               Vector3d&             BiNormal)
{
  ...
  Vector3d n(P, PG); // vecteur definissant la normale
                                               ...
                                               Vector3d&             D2BiNormal)
{
  ...
  Point3d P, PG;
  Vector3d TG, DTG;
  //  Vector3d To,DTo,D2To,B;
  Vector3d To, DTo, D2To;
  ...
  //  Vector3d DTN = DTo.Crossed(Normal);
  //  Vector3d TDN = To.Crossed(DNormal);
  //  Vector3d DT = DTN + TDN;
...
#ifdef OCCT_DEBUG
  Vector3d DTDN = DTo.Crossed(DNormal);
  (void)DTDN;
#endif
...
{
  Handle(GeomFill_GuideTrihedronAC) copy = new (GeomFill_GuideTrihedronAC)(myGuide);
...
void GeomFill_GuideTrihedronAC::Intervals(TColStd_Array1OfReal& TT, const GeomAbs_Shape S) const
{
...
void GeomFill_GuideTrihedronAC::SetInterval(const Standard_Real First, const Standard_Real Last)
{
...
void GeomFill_GuideTrihedronAC::GetAverageLaw(Vector3d& ATangent, Vector3d& ANormal, Vector3d& ABiNormal)
{
  Standard_Integer ii;
...
void GeomFill_GuideTrihedronAC::Origine(const Standard_Real OrACR1, const Standard_Real OrACR2)
{
  Orig1 = OrACR1;
  Orig2 = OrACR2;
}
