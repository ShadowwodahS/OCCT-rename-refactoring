...
void RWStepRepr_RWRepresentation::ReadStep(const Handle(StepData_StepReaderData)& data,
...
void RWStepRepr_RWRepresentation::Share(const Handle(StepRepr_Representation)& ent,
