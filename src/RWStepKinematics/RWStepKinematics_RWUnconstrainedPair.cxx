...
void RWStepKinematics_RWUnconstrainedPair::ReadStep(
  ...
  const Handle(StepKinematics_UnconstrainedPair)& theEnt) const
{
  ...
  if (!theData->CheckNbParams(theNum, 12, theArch, "unconstrained_pair"))
    return;
...
void RWStepKinematics_RWUnconstrainedPair::WriteStep(
...
void RWStepKinematics_RWUnconstrainedPair::Share(
  const Handle(StepKinematics_UnconstrainedPair)& theEnt,
