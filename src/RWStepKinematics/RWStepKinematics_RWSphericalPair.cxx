...
void RWStepKinematics_RWSphericalPair::ReadStep(
  ...
  const Handle(StepKinematics_SphericalPair)& theEnt) const
{
  ...
  if (!theData->CheckNbParams(theNum, 12, theArch, "spherical_pair"))
    return;
...
void RWStepKinematics_RWSphericalPair::WriteStep(
