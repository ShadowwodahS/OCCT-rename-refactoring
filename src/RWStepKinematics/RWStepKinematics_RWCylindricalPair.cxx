...
void RWStepKinematics_RWCylindricalPair::ReadStep(
  ...
  const Handle(StepKinematics_CylindricalPair)& theEnt) const
{
  ...
  if (!theData->CheckNbParams(theNum, 12, theArch, "cylindrical_pair"))
    return;
...
void RWStepKinematics_RWCylindricalPair::WriteStep(
