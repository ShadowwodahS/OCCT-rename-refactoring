...
void RWStepKinematics_RWFullyConstrainedPair::ReadStep(
...
void RWStepKinematics_RWFullyConstrainedPair::WriteStep(
...
void RWStepKinematics_RWFullyConstrainedPair::Share(
  const Handle(StepKinematics_FullyConstrainedPair)& theEnt,
