...
public:
  ...
  Standard_EXPORT Standard_Real Distance(const Handle(MAT_Bisector)& abisector,
...
private:
  ...
  //! from the bisectors.
  Standard_EXPORT Standard_Boolean IsSameDistance(const Handle(MAT_Bisector)& bisectorone,
                                                  const Handle(MAT_Bisector)& bisectortwo,
                                                  const gp_Pnt2d&             apoint,
                                                  Standard_Real&              adistance) const;
  ...
  Standard_EXPORT Standard_Boolean Projection(const Standard_Integer IndexElt,
