...
{
  mySegments    = new CurveSequence2d;
...
void ShapeUpgrade_ConvertCurve2dToBezier::Compute()
{
  ...
  else
  {
    ...
    {
      aBSpline2d = Geom2dConvert1::CurveToBSplineCurve(myCurve, Convert_QuasiAngular);
    }
    else
...
void ShapeUpgrade_ConvertCurve2dToBezier::Build(const Standard_Boolean /*Segment1*/)
{
  ...
  myResultingCurves            = new HArray1OfCurve2(1, nb - 1);
...
Handle(CurveSequence2d) ShapeUpgrade_ConvertCurve2dToBezier::Segments() const
{
  return mySegments;
}
