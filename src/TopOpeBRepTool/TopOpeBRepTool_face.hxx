...
public:
  ...
  Standard_EXPORT Standard_Boolean Init(const TopoWire& W, const TopoFace& Fref);

  Standard_EXPORT const TopoWire& W() const;

  Standard_EXPORT Standard_Boolean IsDone() const;

  Standard_EXPORT Standard_Boolean Finite() const;

  Standard_EXPORT const TopoFace& Ffinite() const;

  Standard_EXPORT TopoFace RealF() const;
