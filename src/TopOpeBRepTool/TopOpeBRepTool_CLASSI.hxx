...
public:
  ...
  Standard_EXPORT void Init2d(const TopoFace& Fref);

  Standard_EXPORT Standard_Boolean HasInit2d() const;

  Standard_EXPORT Standard_Boolean Add2d(const TopoShape& S);

  Standard_EXPORT Standard_Boolean GetBox2d(const TopoShape& S, Bnd_Box2d& Box2d);

  Standard_EXPORT Standard_Integer ClassiBnd2d(const TopoShape&    S1,
                                               const TopoShape&    S2,
                                               const Standard_Real    tol,
                                               const Standard_Boolean checklarge);

  Standard_EXPORT Standard_Integer Classip2d(const TopoShape&    S1,
                                             const TopoShape&    S2,
                                             const Standard_Integer stabnd2d12);

  Standard_EXPORT Standard_Boolean Getface(const TopoShape& S, TopOpeBRepTool_face& fa) const;

  Standard_EXPORT Standard_Boolean Classilist(const ShapeList&         lS,
