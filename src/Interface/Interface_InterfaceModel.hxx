...
public:
  ...
  Standard_EXPORT Standard_Boolean
    IsReportEntity(const Standard_Integer num,
  ...
  //! By default, queries main report, if <semantic> is True, it
  //! queries report for semantic check
  Standard_EXPORT Handle(Interface_ReportEntity) ReportEntity(
  ...
  Standard_EXPORT Standard_Boolean
    AddReportEntity(const Handle(Interface_ReportEntity)& rep,
  ...
  Standard_EXPORT Standard_Boolean SetCategoryNumber(const Standard_Integer num,
  ...
  Standard_EXPORT Interface_EntityIterator
    Reports(const Standard_Boolean semantic = Standard_False) const;
  ...
  Standard_EXPORT const Handle(Interface_Check)& GlobalCheck(
    const Standard_Boolean syntactic = Standard_True) const;
  ...
  Standard_EXPORT virtual void DumpHeader(Standard_OStream&      S,
                                          const Standard_Integer level = 0) const = 0;
  ...
  Standard_EXPORT virtual Standard_Integer NextNumberForLabel(
  ...
  //! surprises
  Standard_EXPORT static Standard_Boolean SetTemplate(
