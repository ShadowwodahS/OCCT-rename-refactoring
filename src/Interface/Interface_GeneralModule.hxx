...
DEFINE_STANDARD_HANDLE(Interface_GeneralModule, RefObject)
...
class Interface_GeneralModule : public RefObject
{
...
public:
  ...
  DEFINE_STANDARD_RTTIEXT(Interface_GeneralModule, RefObject)
