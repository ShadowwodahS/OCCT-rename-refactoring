...
FileNameWriter::FileNameWriter() {}

void FileNameWriter::ReadStep(const Handle(StepData_StepReaderData)& data,
...
void FileNameWriter::WriteStep(StepData_StepWriter&                  SW,
                                           const Handle(HeaderSection_FileName)& ent) const
{
