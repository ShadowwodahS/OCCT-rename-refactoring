                                             ...
                                             Interface_CopyTool&               TC) const
{
  ...
  switch (CN)
  {
    ...
    case 1: {
      ...
      Handle(TCollection_HAsciiString) name = new TCollection_HAsciiString(enfr->Name());
      Handle(TCollection_HAsciiString) time = new TCollection_HAsciiString(enfr->TimeStamp());
      Standard_Integer                 nba  = enfr->NbAuthor();
      Handle(Interface_HArray1OfHAsciiString) auth = new Interface_HArray1OfHAsciiString(1, nba);
      for (i = 1; i <= nba; i++)
        auth->SetValue(i, new TCollection_HAsciiString(enfr->AuthorValue(i)));
      Standard_Integer                        nbo  = enfr->NbOrganization();
      Handle(Interface_HArray1OfHAsciiString) orga = new Interface_HArray1OfHAsciiString(1, nbo);
      for (i = 1; i <= nbo; i++)
      ...
      Handle(TCollection_HAsciiString) autr = new TCollection_HAsciiString(enfr->Authorisation());
    ...
    case 2: {
      ...
      Handle(Interface_HArray1OfHAsciiString) desc = new Interface_HArray1OfHAsciiString(1, nbd);
      for (i = 1; i <= nbd; i++)
    ...
    case 3: {
      ...
      Handle(Interface_HArray1OfHAsciiString) sche = new Interface_HArray1OfHAsciiString(1, nbs);
      for (i = 1; i <= nbs; i++)
