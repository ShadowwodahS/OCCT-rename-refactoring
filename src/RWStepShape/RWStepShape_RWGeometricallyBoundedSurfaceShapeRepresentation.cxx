  ...
  const Handle(StepShape_GeometricallyBoundedSurfaceShapeRepresentation)& ent) const
{
  ...
  if (!data->CheckNbParams(num, 3, ach, "geometrically_bounded_surface_shape_representation"))
    return;
...
void RWStepShape_RWGeometricallyBoundedSurfaceShapeRepresentation::Share(
  const Handle(StepShape_GeometricallyBoundedSurfaceShapeRepresentation)& ent,
