...
void RWStepShape_RWConnectedFaceSet::ReadStep(const Handle(StepData_StepReaderData)&    data,
...
void RWStepShape_RWConnectedFaceSet::Share(const Handle(StepShape_ConnectedFaceSet)& ent,
