  ...
  const Handle(StepShape_CsgShapeRepresentation)& ent) const
{
  ...
  if (!data->CheckNbParams(num, 3, ach, "csg_shape_representation"))
    return;
...
void RWStepShape_RWCsgShapeRepresentation::Share(
  const Handle(StepShape_CsgShapeRepresentation)& ent,
