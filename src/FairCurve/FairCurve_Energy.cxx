...
//=======================================================================
Standard_Boolean FairCurve_Energy::Value(const math_Vector& X, Standard_Real& E)
//=======================================================================
{
...
//=======================================================================
Standard_Boolean FairCurve_Energy::Gradient(const math_Vector& X, math_Vector& G)
//=======================================================================
{
  Standard_Boolean IsDone;
  Standard_Real    E;
...
//=======================================================================
{
  Standard_Integer ii, DebG = Grad.Lower(), FinG = Grad.Upper();
  Standard_Integer Vdeb = 3, Vfin = 2 * MyPoles->Length() - 2;
...
//=======================================================================
Standard_Boolean FairCurve_Energy::Values(const math_Vector& X, Standard_Real& E, math_Vector& G)
//=======================================================================
{
  Standard_Boolean IsDone;
...
//=======================================================================
{
  ...
  if (MyContrOrder1 >= 1)
  {
    Lambda0 = MyPoles->Value(MyPoles->Lower()).Distance(MyPoles->Value(MyPoles->Lower() + 1));
  }

  if (MyContrOrder2 >= 1)
  {
    Lambda1 = MyPoles->Value(MyPoles->Upper()).Distance(MyPoles->Value(MyPoles->Upper() - 1));
  }
  ...
  if (MyContrOrder1 >= 1)
  {
    ...
    if (MyWithAuxValue)
    {
      ...
      H(MyNbVar, 1) = MyLinearForm(0).X() * Vect(kk) + MyLinearForm(0).Y() * Vect(kk + 1);
    }
    ...
    {
      H(ii, 1) = MyLinearForm(0).X() * Vect(kk) + MyLinearForm(0).Y() * Vect(kk + 1);
      kk += Vk;
      Vk++;
    }
  }
  ...
  if (MyContrOrder1 >= 2)
  {
    ...
    for (ii = DebH; ii <= FinH; ii++)
    {
      H(ii, 2) = MyLinearForm(0).X() * Vect(kk) + MyLinearForm(0).Y() * Vect(kk + 1);
  ...
  if (MyWithAuxValue)
  {
    ...
    if (MyContrOrder2 >= 1)
    {
      ...
      H(MyNbVar, FinH + 1) = MyLinearForm(1).X() * Vect(kk) + MyLinearForm(1).Y() * Vect(kk + 1);
    }
    if (MyContrOrder2 >= 2)
    {
...
//=======================================================================
{
  ...
  if (MyContrOrder1 == 2)
  {
    gp_Vec2d b1b2(MyPoles->Value(MyPoles->Lower() + 1), MyPoles->Value(MyPoles->Lower() + 2));
  ...
  if (MyContrOrder2 == 2)
  {
    gp_Vec2d bn2bn1(MyPoles->Value(MyPoles->Upper() - 2), MyPoles->Value(MyPoles->Upper() - 1));
  ...
  if (MyContrOrder2 >= 1)
  {
    X(IndexFin2) = MyPoles->Value(MyPoles->Upper()).Distance(MyPoles->Value(MyPoles->Upper() - 1));
    IndexFin1 -= 1;
  }
