...
DEFINE_STANDARD_HANDLE(IntPatch_TheIWLineOfTheIWalking, RefObject)

class IntPatch_TheIWLineOfTheIWalking : public RefObject
{
...
public:
  ...
  DEFINE_STANDARD_RTTI_INLINE(IntPatch_TheIWLineOfTheIWalking, RefObject)
