...
{
  Point3d* CMyPnts = (Point3d*)C_MyPnts;
  if (C_MyPnts)
    delete[] CMyPnts;
                                   ...
                                   Standard_Integer&      P3) const
{
  ...
  //  Position1 of P1 = MesXYZ(line,colpnt);
  P1 = (line - 1) * (nbdeltaV + 1) + colpnt;

  //  Position1 of P2= MesXYZ(line+1,colpnt+((colon-1)%2));
  P2 = line * (nbdeltaV + 1) + colpnt + ((colon - 1) % 2);

  //  Position1 of P3= MesXYZ(line+(colon%2),colpnt+1);
...
// function : Point
//=======================================================================
const Point3d& IntPatch_Polyhedron::Point(const Standard_Integer Index,
                                         Standard_Real&         U,
                                         Standard_Real&         V) const
{
  Point3d*        CMyPnts = (Point3d*)C_MyPnts;
...
// function : Point
//=======================================================================
const Point3d& IntPatch_Polyhedron::Point(const Standard_Integer Index) const
{
  Point3d* CMyPnts = (Point3d*)C_MyPnts;
  return CMyPnts[Index];
}
...
// function : Point
//=======================================================================
void IntPatch_Polyhedron::Point(const Point3d& /*p*/,
...
// function : Point
//=======================================================================
void IntPatch_Polyhedron::Point(const Standard_Integer Index, Point3d& P) const
{
  Point3d* CMyPnts = (Point3d*)C_MyPnts;
  P               = CMyPnts[Index];
}
