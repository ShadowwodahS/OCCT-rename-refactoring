...
public:
  ...
  Standard_EXPORT static void PrintCurve2d(const Handle(GeomCurve2d)& C,
                                           Standard_OStream&           OS,
  ...
  //! method (compact = True).
  Standard_EXPORT static Handle(GeomCurve2d) ReadCurve2d(Standard_IStream& IS);
