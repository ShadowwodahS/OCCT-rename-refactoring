...
/*********************************************************************************/
void InitEpsSurf(Standard_Real& epsnl,
                 Standard_Real& epsdis,
                 Standard_Real& epsangk1,
                 Standard_Real& epsangk2,
                 Standard_Real& epsangn1,
                 Standard_Real& perce,
...
/*********************************************************************************/
void InitEpsCurv(Standard_Real& epsnl,
                 Standard_Real& epsdis,
                 Standard_Real& epsangk1,
                 Standard_Real& epsangk2,
                 Standard_Real& epsangg1,
                 Standard_Real& epsangg2,
...
static Standard_Integer surfaceCcontinuity(DrawInterpreter& di, Standard_Integer n, const char** a)
{
  ...
  switch (ord)
  {
    ...
    break;
    default:
      Message1::SendFail() << "Error: invalid value of parameter 1 (" << a[1]
                          << "): should be 0, 1, or 2";
      return 1;
  }
...
/***************************************************************************/
void GeometryTest1::ContinuityCommands(DrawInterpreter& theCommands)
{
  ...
  theCommands.Add("surfaceCcontinuity",
                  " surfaceCcontinuity   order surf1 parU1 parV1 surf2 parU2 parV2  [eps_nul[ "
                  "epsC0 [epsC1 [epsC2]]]]",
                  __FILE__,
                  surfaceCcontinuity,
                  g);
  ...
  theCommands.Add("surfaceGcontinuity",
                  " surfaceGcontinuity   order surf1 parU1 parV1 surf2 parU2 parV2  [eps_nul[ "
                  "epsG0 [epsG1[percent [maxlen]]]]",
                  __FILE__,
                  surfaceGcontinuity,
                  g);
  ...
  theCommands.Add("curveGcontinuity",
                  "curveGcontinuity   order  curv1 u1  curv2  u2   [epsnul  [epsG0  [epsG1  [epsG2 "
                  "[percent  [maxlen ]]]]]] ",
                  __FILE__,
                  curveGcontinuity,
                  g);
