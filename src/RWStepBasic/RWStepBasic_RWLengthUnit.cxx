...
void RWStepBasic_RWLengthUnit::ReadStep(const Handle(StepData_StepReaderData)& data,
...
void RWStepBasic_RWLengthUnit::Share(const Handle(StepBasic_LengthUnit)& ent,
