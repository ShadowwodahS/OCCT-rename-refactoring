...
Standard_Boolean Geom2dGcc_FunctionTanObl::Value(const Standard_Real X, Standard_Real& Fval)
{
  gp_Pnt2d Point;
  gp_Vec2d Vect;
...
Standard_Boolean Geom2dGcc_FunctionTanObl::Values(const Standard_Real X,
                                                  Standard_Real&      Fval,
                                                  Standard_Real&      Deriv)
{
  gp_Pnt2d Point;
