...
//! The Prs3d1 package provides the following services
...
//! framework for the DsgPrs1 definitions at work in
...
public:
                                     ...
                                     const Standard_Real    theDeviationCoefficient)
  {
    ...
    return Max(aDiag.maxComp() * theDeviationCoefficient * 4.0, Precision1::Confusion());
  }
