...
bool Prs3d_DatumAspect::DrawDatumPart(Prs3d_DatumParts thePart) const
{
  switch (thePart)
  {
    case Prs3d_DatumParts_Origin:
      return true;
    case Prs3d_DatumParts_XAxis:
      return (myAxes & Prs3d_DatumAxes_XAxis) != 0;
    case Prs3d_DatumParts_XArrow:
      return (myAxes & Prs3d_DatumAxes_XAxis) != 0 && myToDrawArrows;
    case Prs3d_DatumParts_YAxis:
      return (myAxes & Prs3d_DatumAxes_YAxis) != 0;
    case Prs3d_DatumParts_YArrow:
      return (myAxes & Prs3d_DatumAxes_YAxis) != 0 && myToDrawArrows;
    case Prs3d_DatumParts_ZAxis:
      return (myAxes & Prs3d_DatumAxes_ZAxis) != 0;
    case Prs3d_DatumParts_ZArrow:
      return (myAxes & Prs3d_DatumAxes_ZAxis) != 0 && myToDrawArrows;
    case Prs3d_DatumParts_XOYAxis:
      return DrawDatumPart(Prs3d_DatumParts_XAxis) && DrawDatumPart(Prs3d_DatumParts_YAxis);
    case Prs3d_DatumParts_YOZAxis:
      return DrawDatumPart(Prs3d_DatumParts_YAxis) && DrawDatumPart(Prs3d_DatumParts_ZAxis);
    case Prs3d_DatumParts_XOZAxis:
      return DrawDatumPart(Prs3d_DatumParts_XAxis) && DrawDatumPart(Prs3d_DatumParts_ZAxis);
    default:
      break;
  }
  return false;
...
Standard_Real Prs3d_DatumAspect::AxisLength(Prs3d_DatumParts thePart) const
{
  ...
  {
    case Prs3d_DatumParts_XAxis:
      return myAttributes[Prs3d_DatumAttribute_XAxisLength];
    case Prs3d_DatumParts_YAxis:
      return myAttributes[Prs3d_DatumAttribute_YAxisLength];
    case Prs3d_DatumParts_ZAxis:
      return myAttributes[Prs3d_DatumAttribute_ZAxisLength];
    default:
      break;
  }
  return 0.0;
...
Prs3d_DatumParts Prs3d_DatumAspect::ArrowPartForAxis(Prs3d_DatumParts thePart)
{
  switch (thePart)
  {
    case Prs3d_DatumParts_XArrow:
    case Prs3d_DatumParts_XAxis:
      return Prs3d_DatumParts_XArrow;
    case Prs3d_DatumParts_YArrow:
    case Prs3d_DatumParts_YAxis:
      return Prs3d_DatumParts_YArrow;
    case Prs3d_DatumParts_ZArrow:
    case Prs3d_DatumParts_ZAxis:
      return Prs3d_DatumParts_ZArrow;
    default:
      break;
  }
...
void Prs3d_DatumAspect::CopyAspectsFrom(const Handle(Prs3d_DatumAspect)& theOther)
{
  ...
  *myTextAspects[Prs3d_DatumParts_XAxis]->Aspect() =
    *theOther->myTextAspects[Prs3d_DatumParts_XAxis]->Aspect();
  *myTextAspects[Prs3d_DatumParts_YAxis]->Aspect() =
    *theOther->myTextAspects[Prs3d_DatumParts_YAxis]->Aspect();
  *myTextAspects[Prs3d_DatumParts_ZAxis]->Aspect() =
