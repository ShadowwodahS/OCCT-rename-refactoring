...
public:
  ...
  Standard_EXPORT BRepFill_TrimSurfaceTool(const Handle(GeomCurve2d)& Bis,
  ...
  Standard_EXPORT void IntersectWith(const TopoEdge&    EdgeOnF1,
  ...
  Standard_EXPORT Standard_Real ProjOn(const gp_Pnt2d& Point, const TopoEdge& Edge) const;

  Standard_EXPORT void Project(const Standard_Real   U1,
