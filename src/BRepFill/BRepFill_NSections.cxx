                                             ...
                                             const Standard_Real           myPres3d)
{
  ...
  Handle(TColStd_HArray1OfReal) HPar = new TColStd_HArray1OfReal(1, params.Length());
  ...
  Standard_Integer nup = anApprox.SurfPoles().ColLength(), nvp = anApprox.SurfPoles().RowLength();
...
//=======================================================================
// function : Init
// purpose  : Create a table of SectionLaw
//=======================================================================
...
Handle(SectionLaw) BRepFill_NSections::ConcatenedLaw() const
{
