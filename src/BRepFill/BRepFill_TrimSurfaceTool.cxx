  ...
  else
  {
    ...
    switch (GAS.GetType())
    {
      ...
      case GeomAbs_SurfaceOfRevolution: {
        ...
        // of parameter 0 0 on the cone => phase = M_PI.
        //----------------------------------------------------------
        Handle(Geom_SurfaceOfRevolution) GSRev = Handle(Geom_SurfaceOfRevolution)::DownCast(GS);
        Handle(GeomAdaptor_Curve)        HC    = new GeomAdaptor_Curve(GSRev->BasisCurve());
