...
TNaming_DeltaOnModification::TNaming_DeltaOnModification(const Handle(ShapeAttribute)& NS)
...
void TNaming_DeltaOnModification::Apply()
{
  ...
  Handle(ShapeAttribute) NS           = Handle(ShapeAttribute)::DownCast(TDFAttribute);
