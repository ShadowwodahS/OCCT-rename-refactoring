...
BRepGProp_Vinert::BRepGProp_Vinert(const BRepGProp_Face& theSurface, const Point3d& theLocation)
{
  SetLocation(theLocation);
  Perform(theSurface);
}
...
void BRepGProp_Vinert::SetLocation(const Point3d& theLocation)
{
  loc = theLocation;
}
