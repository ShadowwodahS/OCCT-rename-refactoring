...
Quantity_NameOfColor TDataXtd_Presentation::getColorNameFromOldEnum(Standard_Integer theOld)
{
  ...
  if (theOld >= 136 && theOld < 223)
  {
    if (theOld == 146)
    {
      return Quantity_NOC_GRAY2;
    }
    if (theOld == 157)
    {
      return Quantity_NOC_GRAY3;
    }
    if (theOld == 168)
    {
      return Quantity_NOC_GRAY4;
    }
    if (theOld == 179)
    {
      return Quantity_NOC_GRAY5;
    }
    if (theOld == 190)
    {
      return Quantity_NOC_GRAY6;
    }
    if (theOld == 201)
    {
      return Quantity_NOC_GRAY7;
    }
    if (theOld == 212)
    {
      return Quantity_NOC_GRAY8;
    }
    if (theOld == 222)
    {
      return Quantity_NOC_GRAY9;
    }
  ...
  if (theOld == 236)
  {
    return Quantity_NOC_GRAY98;
  }
  if (theOld == 237)
  {
    return Quantity_NOC_GRAY99;
  }
  if (theOld >= 238)
  {
    aNew -= 3;
...
Standard_Integer TDataXtd_Presentation::getOldColorNameFromNewEnum(Quantity_NameOfColor theNew)
{
  ...
  if (theNew >= Quantity_NOC_GRAY2 && theNew <= Quantity_NOC_GRAY89)
  {
    ...
    if (theNew == Quantity_NOC_GRAY3)
    {
      return 157;
    }
    if (theNew == Quantity_NOC_GRAY4)
    {
      return 168;
    }
    if (theNew == Quantity_NOC_GRAY5)
    {
      return 179;
    }
    if (theNew == Quantity_NOC_GRAY6)
    {
      return 190;
    }
    if (theNew == Quantity_NOC_GRAY7)
    {
      return 201;
    }
    if (theNew == Quantity_NOC_GRAY8)
    {
      return 212;
    }
    if (theNew == Quantity_NOC_GRAY9)
    {
      return 222;
    }

    if (theNew >= Quantity_NOC_GRAY80)
    {
      anOld -= 1;
    }
    else if (theNew >= Quantity_NOC_GRAY70)
    {
      anOld -= 2;
    }
    else if (theNew >= Quantity_NOC_GRAY60)
    {
      anOld -= 3;
    }
    else if (theNew >= Quantity_NOC_GRAY50)
    {
      anOld -= 4;
    }
    else if (theNew >= Quantity_NOC_GRAY40)
    {
      anOld -= 5;
    }
    else if (theNew >= Quantity_NOC_GRAY30)
    {
      anOld -= 6;
    }
    else if (theNew >= Quantity_NOC_GRAY20)
    {
      anOld -= 7;
    }
    else
  ...
  if (theNew == Quantity_NOC_GRAY97)
  {
    return 235;
  }
  if (theNew == Quantity_NOC_GRAY98)
  {
    return 236;
  }
  if (theNew == Quantity_NOC_GRAY99)
  {
    return 237;
  }
