...
public:
  ...
  Standard_Boolean IsValid() const { return isValidFrameBuffer(); }
                            ...
                            const Standard_Boolean        theToKeepMsaa = true)
  {
    return InitLazy(theGlCtx,
                    Graphic3d_Vec2i(theFbo.myVPSizeX, theFbo.myVPSizeY),
  ...
  Standard_EXPORT Standard_Boolean
    InitWrapper(const Handle(OpenGl_Context)&                       theGlContext,
...
public:
  ...
  {
    return InitLazy(theGlCtx,
                    Graphic3d_Vec2i(theViewportSizeX, theViewportSizeY),
                    theColorFormat,
                    theDepthFormat,
                    theNbSamples);
  }
...
protected:
  Standard_Boolean isValidFrameBuffer() const { return myGlFBufferId != NO_FRAMEBUFFER; }
