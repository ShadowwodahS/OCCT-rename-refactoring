...
void PerpenPresentation::Add(const Handle(Prs3d_Presentation)& aPresentation,
                                    ...
                                    const Standard_Boolean            intOut2)
{
  ...
  // Symbol
  Vector3d vec1(DirectionBuilder(OffsetPoint, pAx1));
  Vector3d vec2(DirectionBuilder(OffsetPoint, pAx2));
