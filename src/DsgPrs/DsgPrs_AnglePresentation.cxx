...
//==========================================================================
// function : AnglePresentation::Add
// purpose  : draws the presentation of the cone's angle;
//==========================================================================
void AnglePresentation::Add(const Handle(Prs3d_Presentation)& aPresentation,
                                   ...
                                   const Standard_Real               aArrowSize)
{
  ...
  Vector3d Normal = mkPln.Value().Axis().Direction();
  ...
  Vector3d Vec(AttachmentPnt, Apex);                // Dimension arc is a part of the circle 
  Vec.Scale(2.);
  aPnt.Translate(Vec);
  ...
  Text::Draw1(aPresentation->CurrentGroup(), aDimensionAspect->TextAspect(), txt, tmpPnt);
                                   ...
                                   const Point3d&                     OffsetPoint)
{
  ...
  Arrow1::Draw1(aGroup, ptarr, dirarr, LA->ArrowAspect()->Angle(), length);
  ...
  Arrow1::Draw1(aGroup, ptarr, dirarr2, LA->ArrowAspect()->Angle(), length);
                                   ...
                                   const DsgPrs_ArrowSide            ArrowPrs)
{
  ...
  Dir3d        DirOfArrow1, DirOfArrow2;
  DsgPrs1::ComputeFacesAnglePresentation(LA->ArrowAspect()->Length(),
                                        theval,
                                        CenterPoint,
                                        AttachmentPoint1,
                                        AttachmentPoint2,
                                   ...
                                   const Point3d&                     OffsetPoint)
{
  ...
  {
    Dir3d dir2B = Dir3d(Vector3d(CenterPoint, OffsetPoint));
  ...
  Frame3d  ax(CenterPoint, Norm, dir1);
  gp_Circ cer(ax, CenterPoint.Distance(OffsetPoint));
  Vector3d  vec1(dir1);
  vec1 *= cer.Radius();
  Vector3d vec2(dir2);
                                   ...
                                   const DsgPrs_ArrowSide            ArrowPrs)
{
  ...
  DsgPrs1::ComputeSymbol(aPresentation, LA, ptarr, ptarr1, dirarr, dirarr2, ArrowPrs);
}
                                   ...
                                   const DsgPrs_ArrowSide            ArrowSide)
{
  ...
  Dir3d  dir1(Vector3d(CenterPoint, AttachmentPoint1));
  Frame3d  ax(CenterPoint, theAxe.Direction(), dir1);
