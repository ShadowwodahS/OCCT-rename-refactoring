...
//===========================================================================
void Bisector_BisecAna::Perform(const Handle(GeomCurve2d)& afirstcurve,
                                ...
                                const Standard_Boolean      oncurve)
{
  ...
  constexpr Standard_Real PreConf = Precision1::Confusion();
  ...
  switch (cas)
  {
    ...
    case 1: {
          ...
          && (Abs(radius1 - radius2) <= PreConf))
      {
        ...
        Handle(GeomCurve2d) bisectorcurve = new Geom2d_Line(line);
        if (!sense)
          thebisector = new Geom2d_TrimmedCurve(bisectorcurve, parameter, -Precision1::Infinite());
        else
        {
      ...
      if (Bisector1.IsDone())
      {
        ...
        if (!TheSol.IsNull())
        {
          ...
          if (type == GccInt_Lin)
          {
            ...
            Standard_Real secondparameter = Precision1::Infinite();
            if (!thesense)
              secondparameter = -Precision1::Infinite();
          ...
          else if (type == GccInt_Hpr)
          {
            ...
            if (!thesense)
              thebisector =
                new Geom2d_TrimmedCurve(bisectorcurve, firstparameter, -Precision1::Infinite());
            else
              thebisector =
                new Geom2d_TrimmedCurve(bisectorcurve, firstparameter, Precision1::Infinite());
          }
    ...
    case 3: {
      ...
      if (Direc1.IsParallel(Direc2, 1.e-8))
      {
        ...
        if (line1.Distance(line2.Location()) / 2. <= Precision1::Confusion())
      ...
      else
      {
        ...
        if (!thesense)
          thebisector = new Geom2d_TrimmedCurve(bisectorcurve, 0., -Precision1::Infinite());
        else
          thebisector = new Geom2d_TrimmedCurve(bisectorcurve, 0., Precision1::Infinite());
      }
    }
                                ...
                                const Standard_Boolean      oncurve)
{
  ...
  switch (cas)
  {
    ...
    case 1: {
      ...
      Standard_Real         distancemini = Precision1::Infinite();
      if (Bisector1.IsDone())
      {
    ...
    case 2: {
      ...
      if (!thesense)
        ...
        thebisector = new Geom2d_TrimmedCurve(bisectorcurve, firstparameter, Precision1::Infinite());
    }
    break;
...
//=============================================================================
// void Bisector_BisecAna::SetTrim(const Handle(GeomCurve2d)& Cu)
void Bisector_BisecAna::SetTrim(const Handle(GeomCurve2d)&)
{
  /*
    ...
    Handle(GeomCurve2d)        FirstLimit;
    Handle(GeomCurve2d)        LastLimit;
    ...
    if (UB2 > 10000.) {
      UB2 = 10000.;
      Handle(GeomCurve2d)  BasisCurve = thebisector->BasisCurve();
...
void Bisector_BisecAna::D2(const Standard_Real U, gp_Pnt2d& P, gp_Vec2d& V1, gp_Vec2d& V2) const
{
...
Handle(GeomCurve2d) Bisector_BisecAna::Geom2dCurve() const
{
...
void Bisector_BisecAna::Dump(const Standard_Integer, const Standard_Integer Offset) const
{
  Indent(Offset);
