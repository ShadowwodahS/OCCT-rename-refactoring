...
void TopOpeBRepBuild_CorrectFace2d::GetP2dFL(const TopoDS_Face& aF,
...
void TopOpeBRepBuild_CorrectFace2d::BndBoxWire(const TopoDS_Wire& aWire, Bnd_Box2d& B2d) const
{
  Bnd_Box2d       aB2d;
