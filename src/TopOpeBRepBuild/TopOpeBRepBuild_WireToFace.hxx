...
class WireToFaceBuilder
{
public:
  DEFINE_STANDARD_ALLOC

  Standard_EXPORT WireToFaceBuilder();

  Standard_EXPORT void Init();

  Standard_EXPORT void AddWire(const TopoWire& W);

  Standard_EXPORT void MakeFaces(const TopoFace& F, ShapeList& LF);
