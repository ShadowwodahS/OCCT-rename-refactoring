...
public:
  ...
  Standard_EXPORT Standard_Boolean Process(const TopoShape& aGenS, const Sweep_NumShape& aDirV);
  ...
  Standard_EXPORT void SetContinuity(const TopoShape& aGenS, const Sweep_NumShape& aDirS);
