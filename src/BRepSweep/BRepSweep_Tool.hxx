...
public:
  ...
  Standard_EXPORT Standard_Integer Index(const TopoShape& aShape) const;

  //! Returns the Shape at Index anIdex.
  Standard_EXPORT TopoShape Shape(const Standard_Integer anIndex) const;

  //! Returns the type of <aShape>.
  Standard_EXPORT TopAbs_ShapeEnum Type(const TopoShape& aShape) const;

  //! Returns the Orientation of <aShape>.
  Standard_EXPORT TopAbs_Orientation Orientation(const TopoShape& aShape) const;

  //! Set the Orientation of <aShape> with Or.
  Standard_EXPORT void SetOrientation(TopoShape& aShape, const TopAbs_Orientation Or) const;
