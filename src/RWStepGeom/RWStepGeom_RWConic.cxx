...
void RWStepGeom_RWConic::ReadStep(const Handle(StepData_StepReaderData)& data,
...
void RWStepGeom_RWConic::WriteStep(StepData_StepWriter& SW, const Handle(StepGeom_Conic)& ent) const
{
