...
void RWStepGeom_RWCompositeCurve::ReadStep(const Handle(StepData_StepReaderData)& data,
...
void RWStepGeom_RWCompositeCurve::Share(const Handle(StepGeom_CompositeCurve)& ent,
