...
void RWStepGeom_RWBezierSurface::ReadStep(const Handle(StepData_StepReaderData)& data,
...
void RWStepGeom_RWBezierSurface::Share(const Handle(StepGeom_BezierSurface)& ent,
