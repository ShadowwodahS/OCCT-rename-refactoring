...
void RWStepGeom_RWBoundaryCurve::ReadStep(const Handle(StepData_StepReaderData)& data,
...
void RWStepGeom_RWBoundaryCurve::Share(const Handle(StepGeom_BoundaryCurve)& ent,
