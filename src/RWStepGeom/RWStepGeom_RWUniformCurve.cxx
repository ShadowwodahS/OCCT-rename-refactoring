...
void RWStepGeom_RWUniformCurve::ReadStep(const Handle(StepData_StepReaderData)& data,
...
void RWStepGeom_RWUniformCurve::Share(const Handle(StepGeom_UniformCurve)& ent,
