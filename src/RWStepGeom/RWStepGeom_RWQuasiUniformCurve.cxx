...
void RWStepGeom_RWQuasiUniformCurve::ReadStep(const Handle(StepData_StepReaderData)&    data,
...
void RWStepGeom_RWQuasiUniformCurve::WriteStep(StepData_StepWriter&                      SW,
                                               const Handle(StepGeom_QuasiUniformCurve)& ent) const
{
...
void RWStepGeom_RWQuasiUniformCurve::Share(const Handle(StepGeom_QuasiUniformCurve)& ent,
