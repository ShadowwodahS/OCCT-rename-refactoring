...
void RWStepGeom_RWBSplineSurface::ReadStep(const Handle(StepData_StepReaderData)& data,
...
void RWStepGeom_RWBSplineSurface::Share(const Handle(StepGeom_BSplineSurface)& ent,
