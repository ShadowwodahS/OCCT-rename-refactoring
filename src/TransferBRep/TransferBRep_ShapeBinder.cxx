...
TransferBRep_ShapeBinder::TransferBRep_ShapeBinder(const TopoShape& shape)
...
TopoVertex TransferBRep_ShapeBinder::Vertex() const
{
  return TopoDS::Vertex(Result());
}

TopoEdge TransferBRep_ShapeBinder::Edge() const
{
  return TopoDS::Edge(Result());
}

TopoWire TransferBRep_ShapeBinder::Wire() const
{
  return TopoDS::Wire(Result());
}

TopoFace TransferBRep_ShapeBinder::Face() const
{
  return TopoDS::Face(Result());
}

TopoShell TransferBRep_ShapeBinder::Shell() const
{
  return TopoDS::Shell(Result());
}

TopoSolid TransferBRep_ShapeBinder::Solid() const
{
...
TopoCompound TransferBRep_ShapeBinder::Compound() const
{
