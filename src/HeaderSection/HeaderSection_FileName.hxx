...
DEFINE_STANDARD_HANDLE(HeaderSection_FileName, RefObject)

class HeaderSection_FileName : public RefObject
{
...
public:
  ...
  DEFINE_STANDARD_RTTIEXT(HeaderSection_FileName, RefObject)
