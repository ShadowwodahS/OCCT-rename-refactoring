...
DEFINE_STANDARD_HANDLE(StepBasic_ApprovalStatus, RefObject)

class StepBasic_ApprovalStatus : public RefObject
{
...
public:
  ...
  DEFINE_STANDARD_RTTIEXT(StepBasic_ApprovalStatus, RefObject)
