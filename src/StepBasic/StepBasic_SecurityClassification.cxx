...
IMPLEMENT_STANDARD_RTTIEXT(StepBasic_SecurityClassification, RefObject)
...
Handle(StepBasic_SecurityClassificationLevel) StepBasic_SecurityClassification::SecurityLevel()
  const
{
