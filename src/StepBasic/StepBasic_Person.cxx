...
void StepBasic_Person::Init(const Handle(TCollection_HAsciiString)&        aId,
...
Handle(TCollection_HAsciiString) StepBasic_Person::MiddleNamesValue(
...
Handle(TCollection_HAsciiString) StepBasic_Person::PrefixTitlesValue(
  const Standard_Integer num) const
{
...
Handle(TCollection_HAsciiString) StepBasic_Person::SuffixTitlesValue(
  const Standard_Integer num) const
{
