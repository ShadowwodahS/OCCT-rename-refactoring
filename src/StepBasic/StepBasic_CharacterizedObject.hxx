...
DEFINE_STANDARD_HANDLE(StepBasic_CharacterizedObject, RefObject)

//! Representation of STEP entity CharacterizedObject
class StepBasic_CharacterizedObject : public RefObject
{
...
public:
  ...
  DEFINE_STANDARD_RTTIEXT(StepBasic_CharacterizedObject, RefObject)
