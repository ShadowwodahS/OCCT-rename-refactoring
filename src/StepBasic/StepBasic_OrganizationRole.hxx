...
DEFINE_STANDARD_HANDLE(StepBasic_OrganizationRole, RefObject)

class StepBasic_OrganizationRole : public RefObject
{
...
public:
  ...
  DEFINE_STANDARD_RTTIEXT(StepBasic_OrganizationRole, RefObject)
