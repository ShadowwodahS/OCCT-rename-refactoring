...
public:
  ...
  Standard_EXPORT static Standard_Integer NbLabels(const DataLabel& aLabel);
  ...
  Standard_EXPORT static void OutReferers(const DataLabel& theLabel, TDF_AttributeMap& theAtts);
  ...
  //! Caution: <atts> is not cleared before use!
  Standard_EXPORT static void OutReferences(const DataLabel& aLabel, TDF_AttributeMap& atts);
  ...
  Standard_EXPORT static void RelocateLabel(const DataLabel&       aSourceLabel,
  ...
  Standard_EXPORT static void Entry(const DataLabel& aLabel, AsciiString1& anEntry);

  //! Returns the entry of <aLabel> as list of integers
  //! in <aTagList>.
  Standard_EXPORT static void TagList(const DataLabel& aLabel, TColStd_ListOfInteger& aTagList);

  //! Returns the entry expressed by <anEntry> as list
  //! of integers in <aTagList>.
  Standard_EXPORT static void TagList(const AsciiString1& anEntry,
  ...
  Standard_EXPORT static void CountLabels(TDF_LabelList&       aLabelList,
  ...
  Standard_EXPORT static void DeductLabels(TDF_LabelList&       aLabelList,
                                           TDF_LabelIntegerMap& aLabelMap);
