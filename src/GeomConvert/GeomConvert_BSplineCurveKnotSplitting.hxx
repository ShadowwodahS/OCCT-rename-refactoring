...
//! SplitBSplineCurve provided by the package GeomConvert1.
...
public:
  ...
  //! SplitBSplineCurve (provided by the package GeomConvert1) to split the curve.
  //! Exceptions
  ...
  //! package GeomConvert1) to split the curve.
  //! Exceptions
