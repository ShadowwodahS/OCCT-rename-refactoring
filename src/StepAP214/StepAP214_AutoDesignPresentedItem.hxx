...
DEFINE_STANDARD_HANDLE(StepAP214_AutoDesignPresentedItem, PresentedItem)

class StepAP214_AutoDesignPresentedItem : public PresentedItem
{
...
public:
  ...
  Standard_EXPORT void Init(const Handle(HArray1OfAutoDesignPresentedItem)& aItems);

  Standard_EXPORT void SetItems(
    const Handle(HArray1OfAutoDesignPresentedItem)& aItems);

  Standard_EXPORT Handle(HArray1OfAutoDesignPresentedItem) Items() const;
  ...
  DEFINE_STANDARD_RTTIEXT(StepAP214_AutoDesignPresentedItem, PresentedItem)

protected:
private:
  Handle(HArray1OfAutoDesignPresentedItem) items;
};
