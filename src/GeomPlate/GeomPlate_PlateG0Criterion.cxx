...
G0Criterion::G0Criterion(const TColgp_SequenceOfXY&     Data,
...
void G0Criterion::Value(AdvApp2Var_Patch& P, const AdvApp2Var_Context& C) const
{
...
Standard_Boolean G0Criterion::IsSatisfied(const AdvApp2Var_Patch& P) const
{
