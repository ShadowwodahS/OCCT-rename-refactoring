...
public:
  ...
  Standard_EXPORT GeomPlate_BuildPlateSurface(const Standard_Integer Degree      = 3,
                                              const Standard_Integer NbPtsOnCur  = 10,
                                              const Standard_Integer NbIter      = 3,
                                              const Standard_Real    Tol2d       = 0.00001,
                                              const Standard_Real    Tol3d       = 0.0001,
  ...
  Standard_EXPORT Handle(GeomPlate_CurveConstraint) CurveConstraint(
    const Standard_Integer order) const;

  //! returns the PointConstraint of order order
  Standard_EXPORT Handle(GeomPlate_PointConstraint) PointConstraint(
    const Standard_Integer order) const;

  Standard_EXPORT void Disc2dContour(const Standard_Integer nbp, TColgp_SequenceOfXY& Seq2d);

  Standard_EXPORT void Disc3dContour(const Standard_Integer nbp,
...
private:
  ...
  Standard_EXPORT void EcartContraintesMil(const Standard_Integer         c,
  ...
  Standard_EXPORT void LoadPoint(const Standard_Integer NbBoucle,
                                 const Standard_Integer OrderMax = 2);
  ...
  Standard_EXPORT void VerifPoints(Standard_Real& dist,
                                   Standard_Real& ang,
