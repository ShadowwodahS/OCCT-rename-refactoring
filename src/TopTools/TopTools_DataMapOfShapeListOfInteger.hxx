...
typedef NCollection_DataMap<TopoShape, TColStd_ListOfInteger, ShapeHasher>
  TopTools_DataMapOfShapeListOfInteger;
typedef NCollection_DataMap<TopoShape, TColStd_ListOfInteger, ShapeHasher>::Iterator
