...
typedef NCollection_DataMap<TopoShape, Standard_Integer> TopTools_DataMapOfOrientedShapeInteger;
typedef NCollection_DataMap<TopoShape, Standard_Integer>::Iterator
