...
DEFINE_STANDARD_HANDLE(Expr_PolyExpression, Expression1)

class Expr_PolyExpression : public Expression1
{
...
public:
  ...
  const Handle(Expression1)& Operand(const Standard_Integer index) const;
  ...
  DEFINE_STANDARD_RTTIEXT(Expr_PolyExpression, Expression1)
...
protected:
  ...
  Standard_EXPORT void AddOperand(const Handle(Expression1)& exp);
