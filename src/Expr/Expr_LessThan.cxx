...
Expr_LessThan::Expr_LessThan(const Handle(Expression1)& exp1,
...
{
  return new Expr_LessThan(Expr1::CopyShare(FirstMember()), Expr1::CopyShare(SecondMember()));
}

AsciiString1 Expr_LessThan::String() const
{
