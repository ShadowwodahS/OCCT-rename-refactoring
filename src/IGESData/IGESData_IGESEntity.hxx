...
public:
  ...
  Standard_EXPORT Standard_Boolean CResValues(const Standard_CString res1,
  ...
  Standard_EXPORT void InitLineFont(const Handle(IGESData_LineFontEntity)& ent,
  ...
  Standard_EXPORT void InitLevel(const Handle(IGESData_LevelListEntity)& ent,
  ...
  Standard_EXPORT void InitColor(const Handle(IGESData_ColorEntity)& ent,
                                 const Standard_Integer              rank = 0);

  //! Initializes the Status of Directory Part
  Standard_EXPORT void InitStatus(const Standard_Integer blank,
  ...
  Standard_EXPORT void SetLabel(const Handle(TCollection_HAsciiString)& label,
  ...
  Standard_EXPORT void InitMisc(const Handle(IGESData_IGESEntity)&         str,
  ...
  Standard_EXPORT void SetLineWeight(const Standard_Real    defw,
