...
DEFINE_STANDARD_HANDLE(IGESData_NodeOfWriterLib, RefObject)

class IGESData_NodeOfWriterLib : public RefObject
{
...
public:
  ...
  DEFINE_STANDARD_RTTI_INLINE(IGESData_NodeOfWriterLib, RefObject)
