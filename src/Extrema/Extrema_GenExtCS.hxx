...
public:
  ...
  Standard_EXPORT Extrema_GenExtCS(const Curve5&   C,
...
private:
  Standard_EXPORT void GlobMinGenCS(const Curve5& theC,
                                    const Standard_Integer theNbParticles,
                                    const math_Vector&     theTUVinf,
                                    const math_Vector&     theTUVsup,
                                    math_Vector&           theTUV);

  Standard_EXPORT void GlobMinConicS(const Curve5& theC,
                                     const Standard_Integer theNbParticles,
                                     const math_Vector&     theTUVinf,
                                     const math_Vector&     theTUVsup,
                                     math_Vector&           theTUV);

  Standard_EXPORT void GlobMinCQuadric(const Curve5& theC,
                                       const Standard_Integer theNbParticles,
                                       const math_Vector&     theTUVinf,
                                       const math_Vector&     theTUVsup,
                                       math_Vector&           theTUV);
