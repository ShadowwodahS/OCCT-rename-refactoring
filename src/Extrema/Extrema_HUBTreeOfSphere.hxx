...
typedef NCollection_UBTree<Standard_Integer, Sphere2>       Extrema_UBTreeOfSphere;
typedef NCollection_UBTreeFiller<Standard_Integer, Sphere2> Extrema_UBTreeFillerOfSphere;
