...
Extrema_ExtCS::Extrema_ExtCS(const Curve5&   C,
...
void Extrema_ExtCS::Initialize(const SurfaceAdaptor& S,
                               const Standard_Real      TolC,
                               const Standard_Real      TolS)
{
  Initialize(S,
...
void Extrema_ExtCS::Perform(const Curve5& C,
                            const Standard_Real    Uinf,
                            const Standard_Real    Usup)
{
  myucinf = Uinf;
...
Standard_Boolean Extrema_ExtCS::AddSolution(const Curve5& theCurve,
