...
Extrema_GlobOptFuncConicS::Extrema_GlobOptFuncConicS(const SurfaceAdaptor* S,
...
Extrema_GlobOptFuncConicS::Extrema_GlobOptFuncConicS(const Curve5*   C,
...
void Extrema_GlobOptFuncConicS::LoadConic(const Curve5* C,
