...
class Extrema_PCLocFOfLocEPCOfLocateExtPC : public FunctionWithDerivative
{
public:
  ...
  Standard_EXPORT Extrema_PCLocFOfLocEPCOfLocateExtPC(const Point3d& P, const Curve5& C);
