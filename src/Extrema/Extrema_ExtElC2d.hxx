...
public:
  ...
  //! ellipse.
  Standard_EXPORT ExtElC2d(const gp_Lin2d& C1, const gp_Elips2d& C2);

  //! Calculates the distance between a line and a
  //! hyperbola.
  Standard_EXPORT ExtElC2d(const gp_Lin2d& C1, const gp_Hypr2d& C2);

  //! Calculates the distance between a line and a
  //! parabola.
  Standard_EXPORT ExtElC2d(const gp_Lin2d& C1, const gp_Parab2d& C2);

  //! Calculates the distance between two circles.
  //! The circles can be parallel or identical.
  Standard_EXPORT ExtElC2d(const gp_Circ2d& C1, const gp_Circ2d& C2);

  //! Calculates the distance between a circle and an
  //! ellipse.
  Standard_EXPORT ExtElC2d(const gp_Circ2d& C1, const gp_Elips2d& C2);

  //! Calculates the distance between a circle and a
  //! hyperbola.
  Standard_EXPORT ExtElC2d(const gp_Circ2d& C1, const gp_Hypr2d& C2);

  //! Calculates the distance between a circle and a
  //! parabola.
  Standard_EXPORT ExtElC2d(const gp_Circ2d& C1, const gp_Parab2d& C2);
