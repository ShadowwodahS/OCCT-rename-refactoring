...
class Extrema_PCFOfEPCOfELPCOfLocateExtPC : public FunctionWithDerivative
{
public:
  ...
  Standard_EXPORT Extrema_PCFOfEPCOfELPCOfLocateExtPC(const Point3d& P, const Curve5& C);
