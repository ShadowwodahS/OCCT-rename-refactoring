...
class Datum3D2;
DEFINE_STANDARD_HANDLE(Datum3D2, RefObject)
...
public:
  ...
  DEFINE_STANDARD_RTTIEXT(Datum3D2, RefObject)

private:
  Transform3d myTrsf;
};

inline void ShallowDump(const Handle(Datum3D2)& me, Standard_OStream& S)
{
  me->ShallowDump(S);
}
