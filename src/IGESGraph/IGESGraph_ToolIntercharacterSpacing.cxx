...
IntercharacterSpacingTool::IntercharacterSpacingTool() {}

void IntercharacterSpacingTool::ReadOwnParams(
...
void IntercharacterSpacingTool::WriteOwnParams(
  const Handle(IGESGraph_IntercharacterSpacing)& ent,
...
void IntercharacterSpacingTool::OwnShared(
  const Handle(IGESGraph_IntercharacterSpacing)& /*ent*/,
  Interface_EntityIterator& /*iter*/) const
{
}

void IntercharacterSpacingTool::OwnCopy(
...
Standard_Boolean IntercharacterSpacingTool::OwnCorrect(
...
DirectoryChecker IntercharacterSpacingTool::DirChecker(
  const Handle(IGESGraph_IntercharacterSpacing)& /*ent*/) const
{
  DirectoryChecker DC(406, 18);
...
void IntercharacterSpacingTool::OwnCheck(
  const Handle(IGESGraph_IntercharacterSpacing)& ent,
...
void IntercharacterSpacingTool::OwnDump(
  const Handle(IGESGraph_IntercharacterSpacing)& ent,
