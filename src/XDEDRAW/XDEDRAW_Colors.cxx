...
static Standard_Integer setColor(DrawInterpreter&, Standard_Integer argc, const char** argv)
{
  ...
  if (aDoc.IsNull())
  {
    Message1::SendFail() << "Syntax error: " << argv[1] << " is not a document";
    return 1;
  }
  ...
  if (aLabel.IsNull())
  {
    ...
    if (aShape.IsNull())
    {
      Message1::SendFail() << "Syntax error: " << argv[2] << " is not a label nor shape";
      return 1;
    }
  }
                                      ...
                                      const char**      argv)
{
  ...
  if (aLabel.IsNull())
  {
    Message1::SendFail() << "Syntax error: '" << argv[2] << "' label is not found in the document";
    return 1;
  }
  ...
  {
    Message1::SendFail() << "Syntax error: unknown color type '" << argv[3] << "'";
    return 1;
  }
...
static Standard_Integer addColor(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  ...
  if (aNbParsed != argc - 2)
  {
    Message1::SendFail() << "Syntax error at '" << argv[2] << "'";
    return 1;
  }
...
static Standard_Integer setVisibility(DrawInterpreter&, Standard_Integer argc, const char** argv)
{
  ...
  if (aLabel.IsNull())
  {
    Message1::SendFail() << "Syntax error: " << argv[2] << " is not a label not shape";
    return 1;
  }
  ...
  if (argc == 4)
  {
    ...
    {
      Message1::SendFail() << "Syntax error: unknown argument '" << argv[3] << "'";
      return 1;
    }
  }
                                            ...
                                            const char**      argv)
{
  ...
  if (aShape.IsNull())
  {
    Message1::SendFail() << "Syntax error: " << argv[2] << " is not a shape";
    return 1;
  }
...
static Standard_Integer setStyledcolor(DrawInterpreter&, Standard_Integer argc, const char** argv)
{
  ...
  {
    Message1::SendFail() << "Error: cannot set color for the indicated component";
    return 1;
  }
  return 0;
}
                                            ...
                                            const char**      theArgVec)
{
  ...
  if (aDoc.IsNull())
  {
    Message1::SendFail() << "Syntax error: " << theArgVec[1] << " is not a document";
    return 1;
  }
                                        ...
                                        const char**      theArgVec)
{
  ...
  else
  {
    ...
    if (!aShapeLab.IsNull() && !aMatTool->ShapeTool()->IsShape(aShapeLab))
    {
      aShapeLab.Nullify();
    }
    if (aShapeLab.IsNull())
    {
      Message1::SendFail() << "Syntax error: " << theArgVec[2] << " is not material nor shape";
      return 1;
    }
                                        ...
                                        const char**     theArgVec)
{
  ...
  for (Standard_Integer anArgIter = 3; anArgIter < theNbArgs; ++anArgIter)
  {
    ...
    else if (anArg == "-diffuse" || anArg == "-basecolor" || anArg == "-albedo")
    {
      ...
      else
      {
        ...
        else
        {
          aMatPbr.BaseColor.SetRGB(aColorRGBA.GetRGB());
             ...
             && parseRgbColor(anArgIter, aMatCom.SpecularColor, theNbArgs, theArgVec))
    {
      aMatCom.IsDefined = true;
    }
    else if (anArg == "-ambient"
             && parseRgbColor(anArgIter, aMatCom.AmbientColor, theNbArgs, theArgVec))
    {
      aMatCom.IsDefined = true;
    }
    else if (anArg == "-emissive"
             && parseRgbColor(anArgIter, aMatCom.EmissiveColor, theNbArgs, theArgVec))
    {
      aMatCom.IsDefined = true;
    }
    ...
    else if (anArgIter + 1 < theNbArgs && anArg == "-metallic"
             && parseNormalizedReal(theArgVec[anArgIter + 1], aMatPbr.Metallic))
    {
      ++anArgIter;
      aMatPbr.IsDefined = true;
    }
    else if (anArgIter + 1 < theNbArgs && anArg == "-roughness"
                                           ...
                                           const char**     theArgVec)
{
  ...
  if (aMatLab.IsNull())
  {
    Message1::SendFail() << "Syntax error: " << theArgVec[2] << " is not a material";
    return 1;
  }
                                        ...
                                        const char**     theArgVec)
{
  ...
  if (aShapeLab.IsNull())
  {
    Message1::SendFail() << "Syntax error: " << theArgVec[2] << " is not a label not shape";
    return 1;
  }
  ...
  if (theNbArgs == 4)
  {
    ...
    if (aMatLab.IsNull())
    {
      Message1::SendFail() << "Syntax error: " << theArgVec[3] << " is not a material";
      return 1;
    }
  }
...
void ColorCommands::InitCommands(DrawInterpreter& di)
{
  ...
  di.Add("XSetColor",
         "Doc {Label|Shape} R G B [alpha] [{generic|surface|curve}=gen]"
  ...
  di.Add("XGetShapeColor",
         "Doc Label {generic|surface|curve}"
         "\t: Returns color defined by label",
         __FILE__,
         getShapeColor,
         g);

  di.Add("XGetAllColors",
         "Doc"
  ...
  di.Add("XUnsetColor",
         "Doc {Label|Shape} {generic|surface|curve}"
         "\t: Unset color",
         __FILE__,
         unsetColor,
         g);

  di.Add("XSetObjVisibility",
         "Doc {Label|Shape} (0\1) \t: Set the visibility of shape  ",
         __FILE__,
         setVisibility,
         g);

  di.Add("XGetObjVisibility",
         "Doc {Label|Shape} \t: Return the visibility of shape ",
         __FILE__,
         getVisibility,
         g);

  di.Add("XGetInstanceVisible",
         "Doc Shape \t: Return the visibility of shape ",
         __FILE__,
         getStyledVisibility,
         g);

  di.Add("XGetInstanceColor",
         "Doc Shape [{generic|surface|curve}=gen]"
         "\t: Return the color of component shape",
         __FILE__,
         getStyledcolor,
         g);

  di.Add("XSetInstanceColor",
         "Doc Shape R G B [alpha] [{generic|surface|curve}=gen]"
         "\t: sets color for component of shape if SHUO structure exists already",
         __FILE__,
         setStyledcolor,
         g);

  di.Add("XGetAllVisMaterials",
         "Doc [{-names|-labels}=-names]"
         "\t: Print all visualization materials defined in document",
         __FILE__,
         XGetAllVisMaterials,
         g);
  di.Add("XGetVisMaterial",
         "Doc {Material|Shape}"
  ...
  di.Add("XAddVisMaterial",
         ...
         XAddVisMaterial,
         g);
  di.Add("XRemoveVisMaterial",
         "Doc Material"
         "\t: Remove material in document from material table",
         __FILE__,
         XRemoveVisMaterial,
         g);
  di.Add("XSetVisMaterial",
         "Doc Shape Material"
         "\t: Set material to shape",
         __FILE__,
         XSetVisMaterial,
         g);
  di.Add("XUnsetVisMaterial",
         "Doc Shape"
