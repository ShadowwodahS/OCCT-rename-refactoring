...
static Standard_Integer DumpDGTs(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 3)
  {
    ...
    for (Standard_Integer j = 1; j <= aGDTs.Length(); j++)
    {
      ...
      if (aGDTs.Value(j).FindAttribute(XCAFDoc_GeomTolerance::GetID(), aDimTol))
      {
        ...
        if (argc > 3)
        {
          ...
          if (aDimTolObj->GetMaterialRequirementModifier()
...
static Standard_Integer DumpNbDGTs(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 2)
  {
  ...
  if (isFull)
  {
    ...
    for (Standard_Integer i = 1; i <= aGDTs.Length(); i++)
    {
      ...
      else if (GeometricToleranceProperty::IsDimensionalLocation(aDimType))
      {
        nbLocation++;
      }
...
static Standard_Integer addDim(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 3)
  {
  ...
  DataLabel aDimL = aDimTolTool->AddDimension();
  if (aLabel1.IsNull())
...
static Standard_Integer addGTol(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 3)
  {
...
static Standard_Integer addDatum(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 3)
  {
...
static Standard_Integer setDatum(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 4)
  {
...
static Standard_Integer setDatumPosition(DrawInterpreter& di,
                                         ...
                                         const char**      argv)
{
  ...
  if (Draw1::Atoi(argv[3]) < 1 || Draw1::Atoi(argv[3]) > 3)
  {
  ...
  if (aLabel.FindAttribute(XCAFDoc_Datum::GetID(), aDatum))
  {
    ...
    anObj->SetPosition(Draw1::Atoi(argv[3]));
    aDatum->SetObject(anObj);
  }
  return 0;
}

static Standard_Integer getDatumPosition(DrawInterpreter& di,
                                         Standard_Integer  argc,
                                         const char**      argv)
{
  if (argc < 3)
...
static Standard_Integer getDatum(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 3)
  {
...
static Standard_Integer addDatumModif(DrawInterpreter& di,
                                      Standard_Integer  argc,
                                      const char**      argv)
{
  if (argc < 4)
  ...
  if (aLabel.FindAttribute(XCAFDoc_Datum::GetID(), aDatum))
  {
    ...
    {
      if (Draw1::Atoi(argv[i]) < 22 && Draw1::Atoi(argv[i]) > -1)
      {
        Handle(XCAFDimTolObjects_DatumObject) anObj = aDatum->GetObject();
        anObj->AddModifier((XCAFDimTolObjects_DatumSingleModif)Draw1::Atoi(argv[i]));
        aDatum->SetObject(anObj);
      }
    }
  }
...
static Standard_Integer getDatumModif(DrawInterpreter& di,
                                      Standard_Integer  argc,
                                      const char**      argv)
{
  if (argc < 3)
    ...
    for (Standard_Integer i = 1; i <= aS.Length(); i++)
    {
      ...
      switch (aS.Value(i))
      {
        case 0:
          ...
          break;
        case 1:
          di << "AnyLongitudinalSection";
          break;
        case 2:
          di << "Basic";
          break;
        case 3:
          di << "ContactingFeature\n";
          break;
        case 4:
          di << "DegreeOfFreedomConstraintU";
          break;
        case 5:
          di << "DegreeOfFreedomConstraintV";
          break;
        case 6:
          di << "DegreeOfFreedomConstraintW";
          break;
        case 7:
          di << "DegreeOfFreedomConstraintX";
          break;
        case 8:
          di << "DegreeOfFreedomConstraintY";
          break;
        case 9:
          di << "DegreeOfFreedomConstraintZ";
          break;
        case 10:
          di << "DistanceVariable";
          break;
...
static Standard_Integer setDatumName(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 4)
  {
...
static Standard_Integer getDatumName(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 3)
  {
...
static Standard_Integer setTypeOfTol(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 4)
  {
  ...
  {
    if (Draw1::Atoi(argv[3]) > -1 && Draw1::Atoi(argv[3]) < 16)
    {
      Handle(XCAFDimTolObjects_GeomToleranceObject) anObj = aGeomTolerance->GetObject();
      anObj->SetType((XCAFDimTolObjects_GeomToleranceType)Draw1::Atoi(argv[3]));
...
static Standard_Integer getTypeOfTol(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 3)
  {
...
static Standard_Integer setTypeOfTolVal(DrawInterpreter& di,
                                        Standard_Integer  argc,
                                        const char**      argv)
{
  if (argc < 4)
  ...
  if (aLabel.FindAttribute(XCAFDoc_GeomTolerance::GetID(), aGeomTolerance))
  {
    ...
    {
      Handle(XCAFDimTolObjects_GeomToleranceObject) anObj = aGeomTolerance->GetObject();
      anObj->SetTypeOfValue((XCAFDimTolObjects_GeomToleranceTypeValue)Draw1::Atoi(argv[3]));
      aGeomTolerance->SetObject(anObj);
    }
  }
  return 0;
...
static Standard_Integer getTypeOfTolVal(DrawInterpreter& di,
                                        Standard_Integer  argc,
                                        const char**      argv)
{
  if (argc < 3)
...
static Standard_Integer setTolVal(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 4)
  {
  ...
  {
    Handle(XCAFDimTolObjects_GeomToleranceObject) anObj = aGeomTolerance->GetObject();
    anObj->SetValue(Draw1::Atof(argv[3]));
    aGeomTolerance->SetObject(anObj);
  }
  return 0;
}

static Standard_Integer getTolVal(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 3)
  {
...
static Standard_Integer setMatReq(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 4)
  {
  ...
  if (aLabel.FindAttribute(XCAFDoc_GeomTolerance::GetID(), aGeomTolerance))
  {
    if (Draw1::Atoi(argv[3]) > -1 && Draw1::Atoi(argv[3]) < 3)
    {
      ...
      anObj->SetMaterialRequirementModifier(
        (XCAFDimTolObjects_GeomToleranceMatReqModif)Draw1::Atoi(argv[3]));
      aGeomTolerance->SetObject(anObj);
    }
  }
  return 0;
...
static Standard_Integer getMatReq(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 3)
  {
...
static Standard_Integer setZoneMod(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 4)
  {
  ...
  if (aLabel.FindAttribute(XCAFDoc_GeomTolerance::GetID(), aGeomTolerance))
  {
    ...
    {
      Handle(XCAFDimTolObjects_GeomToleranceObject) anObj = aGeomTolerance->GetObject();
      anObj->SetZoneModifier((XCAFDimTolObjects_GeomToleranceZoneModif)Draw1::Atoi(argv[3]));
      aGeomTolerance->SetObject(anObj);
    }
  }
  return 0;
...
static Standard_Integer getZoneMod(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 3)
  {
...
static Standard_Integer setZoneModVal(DrawInterpreter& di,
                                      Standard_Integer  argc,
                                      const char**      argv)
{
  if (argc < 4)
  ...
  {
    Handle(XCAFDimTolObjects_GeomToleranceObject) anObj = aGeomTolerance->GetObject();
    anObj->SetValueOfZoneModifier(Draw1::Atof(argv[3]));
    aGeomTolerance->SetObject(anObj);
  }
  return 0;
}

static Standard_Integer getZoneModVal(DrawInterpreter& di,
                                      Standard_Integer  argc,
                                      const char**      argv)
{
  if (argc < 3)
...
static Standard_Integer addTolModif(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 4)
  {
  ...
  if (aLabel.FindAttribute(XCAFDoc_GeomTolerance::GetID(), aGeomTolerance))
  {
    for (Standard_Integer i = 3; i < argc; i++)
    {
      if (Draw1::Atoi(argv[i]) > -1 && Draw1::Atoi(argv[i]) < 17)
      {
        Handle(XCAFDimTolObjects_GeomToleranceObject) anObj = aGeomTolerance->GetObject();
        anObj->AddModifier((XCAFDimTolObjects_GeomToleranceModif)Draw1::Atoi(argv[i]));
        aGeomTolerance->SetObject(anObj);
      }
    }
  }
...
static Standard_Integer getTolModif(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 3)
  {
  ...
  if (aLabel.FindAttribute(XCAFDoc_GeomTolerance::GetID(), aGeomTolerance))
  {
    ...
    for (Standard_Integer i = 1; i <= aS.Length(); i++)
    {
      ...
      {
        case 0:
          di << "Any_Cross_Section";
          break;
        case 1:
          di << "Common_Zone";
          break;
        case 2:
          di << "Each_Radial_Element";
          break;
        case 3:
          di << "Free_State";
          break;
        case 4:
          di << "Least_Material_Requirement";
          break;
        case 5:
          di << "Line_Element";
          break;
        case 6:
          ...
          break;
        case 7:
          di << "Maximum_Material_Requirement";
          break;
        case 8:
          di << "Minor_Diameter";
          break;
        ...
        case 10:
          ...
          break;
        case 11:
          di << "Reciprocity_Requirement";
          break;
        case 12:
          di << "Separate_Requirement";
          break;
        case 13:
          di << "Statistical_Tolerance";
          break;
        case 14:
          di << "Tangent_Plane";
          break;
...
static Standard_Integer setTolMaxVal(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 4)
  {
  ...
  {
    Handle(XCAFDimTolObjects_GeomToleranceObject) anObj = aGeomTolerance->GetObject();
    anObj->SetMaxValueModifier(Draw1::Atof(argv[3]));
    aGeomTolerance->SetObject(anObj);
  }
  return 0;
}

static Standard_Integer getTolMaxVal(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 3)
  {
...
static Standard_Integer setDimType(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 4)
  {
  ...
  {
    if (Draw1::Atoi(argv[3]) > -1 && Draw1::Atoi(argv[3]) < 30)
    {
      Handle(XCAFDimTolObjects_DimensionObject) anObj = aDimension->GetObject();
      anObj->SetType((XCAFDimTolObjects_DimensionType)Draw1::Atoi(argv[3]));
...
static Standard_Integer getDimType(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 3)
  {
  ...
  if (aLabel.FindAttribute(XCAFDoc_Dimension::GetID(), aDimension))
  {
    switch (aDimension->GetObject()->GetType())
    {
      case 0:
        ...
        break;
      case 1:
        di << "Location_CurvedDistance";
        break;
      case 2:
        di << "Location_LinearDistance";
        break;
      case 3:
        di << "Location_LinearDistance_FromCenterToOuter";
        break;
      case 4:
        di << "Location_LinearDistance_FromCenterToInner";
        break;
      case 5:
        di << "Location_LinearDistance_FromOuterToCenter";
        break;
      case 6:
        di << "Location_LinearDistance_FromOuterToOuter";
        break;
      case 7:
        di << "Location_LinearDistance_FromOuterToInner";
        break;
      case 8:
        di << "Location_LinearDistance_FromInnerToCenter";
        break;
      case 9:
        di << "Location_LinearDistance_FromInnerToOuter";
        break;
      case 10:
        di << "Location_LinearDistance_FromInnerToInner";
        break;
      case 11:
        di << "Location_Angular";
        break;
      case 12:
        di << "Location_Oriented";
        break;
      case 13:
        di << "Location_WithPath";
        break;
      case 14:
        di << "Size_CurveLength";
        break;
      case 15:
        ...
        break;
      case 16:
        di << "Size_SphericalDiameter";
        break;
      case 17:
        di << "Size_Radius";
        break;
      case 18:
        di << "Size_SphericalRadius";
        break;
      case 19:
        di << "Size_ToroidalMinorDiameter";
        break;
      case 20:
        di << "Size_ToroidalMajorDiameter";
        break;
      case 21:
        di << "Size_ToroidalMinorRadius";
        break;
      case 22:
        di << "Size_ToroidalMajorRadius";
        break;
      case 23:
        di << "Size_ToroidalHighMajorDiameter";
        break;
      case 24:
        di << "Size_ToroidalLowMajorDiameter";
        break;
      case 25:
        di << "Size_ToroidalHighMajorRadius";
        break;
      case 26:
        di << "Size_ToroidalLowMajorRadius";
        break;
      case 27:
        di << "Size_Thickness";
        break;
...
static Standard_Integer setDimVal(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 4)
  {
...
static Standard_Integer getDimVal(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 3)
  {
...
static Standard_Integer setDimQalif(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 4)
  {
  ...
  if (aLabel.FindAttribute(XCAFDoc_Dimension::GetID(), aDimension))
  {
    if (Draw1::Atoi(argv[3]) > -1 && Draw1::Atoi(argv[3]) < 4)
    {
      Handle(XCAFDimTolObjects_DimensionObject) anObj = aDimension->GetObject();
      anObj->SetQualifier((XCAFDimTolObjects_DimensionQualifier)Draw1::Atoi(argv[3]));
      aDimension->SetObject(anObj);
    }
  }
  return 0;
...
static Standard_Integer getDimQalif(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 3)
  {
...
static Standard_Integer setDimRange(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 5)
  {
  ...
  if (aLabel.FindAttribute(XCAFDoc_Dimension::GetID(), aDimension))
  {
    if (Draw1::Atof(argv[3]) < Draw1::Atof(argv[4]))
    {
      Handle(XCAFDimTolObjects_DimensionObject) anObj = aDimension->GetObject();
      anObj->SetLowerBound(Draw1::Atof(argv[3]));
      anObj->SetUpperBound(Draw1::Atof(argv[4]));
      aDimension->SetObject(anObj);
    }
  }
  return 0;
...
static Standard_Integer getDimRange(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 3)
  {
...
static Standard_Integer setDimPlusMinusTol(DrawInterpreter& di,
                                           Standard_Integer  argc,
                                           const char**      argv)
{
  if (argc < 5)
  ...
  if (aLabel.FindAttribute(XCAFDoc_Dimension::GetID(), aDimension))
  {
    ...
    {
      Handle(XCAFDimTolObjects_DimensionObject) anObj = aDimension->GetObject();
      anObj->SetLowerTolValue(Draw1::Atof(argv[3]));
      anObj->SetUpperTolValue(Draw1::Atof(argv[4]));
      aDimension->SetObject(anObj);
    }
  }
  return 0;
...
static Standard_Integer getDimPlusMinusTol(DrawInterpreter& di,
                                           Standard_Integer  argc,
                                           const char**      argv)
{
  if (argc < 3)
...
static Standard_Integer setDimClassTol(DrawInterpreter& di,
                                       Standard_Integer  argc,
                                       const char**      argv)
{
  if (argc < 6)
  ...
  if (aLabel.FindAttribute(XCAFDoc_Dimension::GetID(), aDimension))
  {
    if (Draw1::Atoi(argv[4]) > 0 && Draw1::Atoi(argv[4]) < 29 && Draw1::Atoi(argv[5]) > -1
        && Draw1::Atoi(argv[5]) < 20)
    {
      Handle(XCAFDimTolObjects_DimensionObject) anObj = aDimension->GetObject();
      anObj->SetClassOfTolerance((Draw1::Atoi(argv[3]) != 0),
                                 (XCAFDimTolObjects_DimensionFormVariance)Draw1::Atoi(argv[4]),
                                 (XCAFDimTolObjects_DimensionGrade)Draw1::Atoi(argv[5]));
      aDimension->SetObject(anObj);
    }
  }
  return 0;
...
static Standard_Integer getDimClassTol(DrawInterpreter& di,
                                       Standard_Integer  argc,
                                       const char**      argv)
{
  if (argc < 3)
...
static Standard_Integer setDimNbOfDecimalPlaces(DrawInterpreter& di,
                                                Standard_Integer  argc,
                                                const char**      argv)
{
  if (argc < 5)
  ...
  {
    Handle(XCAFDimTolObjects_DimensionObject) anObj = aDimension->GetObject();
    anObj->SetNbOfDecimalPlaces(Draw1::Atoi(argv[3]), Draw1::Atoi(argv[4]));
    aDimension->SetObject(anObj);
  }
  return 0;
}

static Standard_Integer getDimNbOfDecimalPlaces(DrawInterpreter& di,
                                                Standard_Integer  argc,
                                                const char**      argv)
{
  if (argc < 3)
...
static Standard_Integer addDimModifier(DrawInterpreter& di,
                                       Standard_Integer  argc,
                                       const char**      argv)
{
  if (argc < 4)
  ...
  if (aLabel.FindAttribute(XCAFDoc_Dimension::GetID(), aDimension))
  {
    for (Standard_Integer i = 3; i < argc; i++)
    {
      if (Draw1::Atoi(argv[i]) > -1 && Draw1::Atoi(argv[i]) < 24)
      {
        Handle(XCAFDimTolObjects_DimensionObject) anObj = aDimension->GetObject();
        anObj->AddModifier((XCAFDimTolObjects_DimensionModif)Draw1::Atoi(argv[i]));
        aDimension->SetObject(anObj);
      }
    }
  }
...
static Standard_Integer getDimModifier(DrawInterpreter& di,
                                       Standard_Integer  argc,
                                       const char**      argv)
{
  if (argc < 3)
    ...
    for (Standard_Integer i = 1; i <= aS.Length(); i++)
    {
      ...
      switch (aS.Value(i))
      {
        ...
        case 1:
          ...
          break;
        case 2:
          di << "StatisticalTolerance";
          break;
        case 3:
          di << "ContinuousFeature";
          break;
        case 4:
          di << "TwoPointSize";
          break;
        case 5:
          di << "LocalSizeDefinedBySphere";
          break;
        case 6:
          di << "LeastSquaresAssociationCriterion";
          break;
        case 7:
          di << "MaximumInscribedAssociation";
          break;
        case 8:
          di << "MinimumCircumscribedAssociation";
          break;
        case 9:
          di << "CircumferenceDiameter";
          break;
        case 10:
          di << "AreaDiameter";
          break;
        ...
        case 17:
          ...
          break;
        case 18:
          di << "AnyRestrictedPortionOfFeature";
          break;
        case 19:
          di << "AnyCrossSection";
          break;
        case 20:
          di << "SpecificFixedCrossSection";
          break;
        case 21:
          di << "CommonTolerance";
          break;
        case 22:
          di << "FreeStateCondition";
          break;
        case 23:
          di << "Between";
          break;
...
static Standard_Integer addDimPath(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 4)
  {
  ...
  if (aLabel.FindAttribute(XCAFDoc_Dimension::GetID(), aDimension))
  {
    TopoEdge aE = TopoDS::Edge(DBRep1::Get(argv[3], TopAbs_EDGE));
    if (!aE.IsNull())
    {
      Handle(XCAFDimTolObjects_DimensionObject) anObj = aDimension->GetObject();
      anObj->SetPath(aE);
...
static Standard_Integer addDimPoints(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 4)
  {
  ...
  if (aLabel.FindAttribute(XCAFDoc_Dimension::GetID(), aDimension))
  {
    ...
    TopoVertex aV1 = TopoDS::Vertex(DBRep1::Get(argv[3], TopAbs_VERTEX));
    if (!aV1.IsNull())
    {
      anObj->SetPoint(BRepInspector::Pnt(aV1));
    }
    if (argc == 5)
    {
      TopoVertex aV2 = TopoDS::Vertex(DBRep1::Get(argv[4], TopAbs_VERTEX));
      if (!aV2.IsNull())
      {
        anObj->SetPoint2(BRepInspector::Pnt(aV2));
      }
    }
    aDimension->SetObject(anObj);
  }
...
static Standard_Integer getDimPoints(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 3)
  {
  ...
  if (aLabel.FindAttribute(XCAFDoc_Dimension::GetID(), aDimension))
  {
    ...
    if (anObj->HasPoint2())
    {
      di << anObj->GetPoint2().X() << ";" << anObj->GetPoint2().Y() << ";"
         << anObj->GetPoint2().Z();
    }
  }
  return 0;
...
static Standard_Integer addDimDir(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 6)
  {
  ...
  {
    Handle(XCAFDimTolObjects_DimensionObject) anObj = aDimension->GetObject();
    anObj->SetDirection(Dir3d(Draw1::Atof(argv[3]), Draw1::Atof(argv[4]), Draw1::Atof(argv[5])));
    aDimension->SetObject(anObj);
  }
  return 0;
}

static Standard_Integer getDimDir(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 3)
  {
...
static Standard_Integer addDimDescr(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 4)
  {
...
static Standard_Integer getDimDescr(DrawInterpreter& di, Standard_Integer argc, const char** argv)
{
  if (argc < 3)
  {
...
static Standard_Integer addGDTPosition(DrawInterpreter& di,
                                       Standard_Integer  argc,
                                       const char**      argv)
{
  if (argc < 12)
  {
    di << "Use: XSetGDTPosition Doc GDT_Label loc_x loc_y loc_z normal_x normal_y normal_z xdir_x "
          "xdir_y xdir_z\n";
    return 1;
  }
  Handle(AppDocument) Doc;
  ...
  Point3d aPoint(Draw1::Atof(argv[3]), Draw1::Atof(argv[4]), Draw1::Atof(argv[5]));
  Dir3d aNormal(Draw1::Atof(argv[6]), Draw1::Atof(argv[7]), Draw1::Atof(argv[8]));
  Dir3d aDir(Draw1::Atof(argv[9]), Draw1::Atof(argv[10]), Draw1::Atof(argv[11]));
...
static Standard_Integer getGDTPosition(DrawInterpreter& di,
                                       Standard_Integer  argc,
                                       const char**      argv)
{
  if (argc < 3)
...
static Standard_Integer addGDTPresentation(DrawInterpreter& di,
                                           Standard_Integer  argc,
                                           const char**      argv)
{
  if (argc < 5)
  ...
  TopoShape                     aPresentation = DBRep1::Get(argv[3]);
...
static Standard_Integer getGDTPresentation(DrawInterpreter& di,
                                           Standard_Integer  argc,
                                           const char**      argv)
{
  if (argc < 3)
  ...
  DBRep1::Set(argv[3], aPresentation);
  return 0;
}

static Standard_Integer addGDTAffectedPlane(DrawInterpreter& di,
                                            Standard_Integer  argc,
                                            const char**      argv)
{
  if (argc != 5)
  ...
  Handle(GeomSurface) aSurf  = DrawTrSurf1::GetSurface(argv[3]);
...
static Standard_Integer getGDTAffectedPlane(DrawInterpreter& di,
                                            Standard_Integer  argc,
                                            const char**      argv)
{
  if (argc != 4)
  ...
  if (aLabel.FindAttribute(XCAFDoc_GeomTolerance::GetID(), aGeomTolerance))
  {
    ...
    DrawTrSurf1::Set(argv[3], aPlane);
  }

  return 0;
}

static Standard_Integer getGDTSemanticName(DrawInterpreter& di,
                                           Standard_Integer  argc,
                                           const char**      argv)
{
  if (argc < 3)
...
static Standard_Integer setGDTSemanticName(DrawInterpreter& di,
                                           Standard_Integer  argc,
                                           const char**      argv)
{
  if (argc < 3)
...
void XDEDRAW_GDTs::InitCommands(DrawInterpreter& di)
{
  ...
  di.Add("XDumpNbDGTs", "XDumpNbDGTs Doc [f (full dumping)]", __FILE__, DumpNbDGTs, g);

  di.Add("XAddDimension", "XAddDimension Doc shape/label [shape/label]", __FILE__, addDim, g);

  di.Add("XAddGeomTolerance", "XAddGeomTolerance Doc shape/label", __FILE__, addGTol, g);

  di.Add("XAddDatum", "XAddDatum Doc shape1/label1 ... shapeN/labelN", __FILE__, addDatum, g);

  di.Add("XSetDatum", "XSetDatum Doc Datum_Label GeomTol_Label", __FILE__, setDatum, g);

  di.Add("XGetDatum", "XGetDatum Doc GeomTol_Label/Shape_Label", __FILE__, getDatum, g);

  di.Add("XAddDatumModifier",
         "XAddDatumModifier Doc Datum_Label mod1 mod2 ...\n"
         "Values:"
         "\n  0 AnyCrossSection"
  ...
  di.Add("XGetDatumModifiers", "XGetDatumModifiers Doc Datum_Label", __FILE__, getDatumModif, g);

  di.Add("XSetDatumName", "XSetDatumName Doc Datum_Label name", __FILE__, setDatumName, g);

  di.Add("XGetDatumName", "XGetDatumName Doc Datum_Label", __FILE__, getDatumName, g);

  di.Add("XSetDatumPosition",
         "XSetDatumPosition Doc Datum_Label position[1-3]"
         "Set datum position number in geometric tolerance datum system",
         __FILE__,
         setDatumPosition,
         g);

  di.Add("XGetDatumPosition", "XGetDatumPosition Doc Datum_Label", __FILE__, getDatumPosition, g);

  di.Add("XSetTypeOfTolerance",
         "XSetTypeOfTolerance Doc GTol_Label type"
         "Values:\n"
         "\t  0 type is absent\n"
         "\t  1 Angularity\n"
         "\t  2 CircularRunout\n"
  ...
  di.Add("XGetTypeOfTolerance", "XGetTypeOfTolerance Doc GTol_Label", __FILE__, getTypeOfTol, g);

  di.Add("XSetTypeOfToleranceValue",
         "XSetTypeOfToleranceValue Doc GTol_Label type"
         "Values:"
         "\n  0 none"
         "\n  1 Diameter"
         "\n  2 SphericalDiameter",
  ...
  di.Add("XGetTypeOfToleranceValue",
         "XGetTypeOfToleranceValue Doc GTol_Label",
         __FILE__,
         getTypeOfTolVal,
         g);

  di.Add("XSetToleranceValue", "XSetToleranceValue Doc GTol_Label value", __FILE__, setTolVal, g);

  di.Add("XGetToleranceValue", "XGetToleranceValue Doc GTol_Label", __FILE__, getTolVal, g);

  di.Add("XSetTolMaterialReq",
         "XSetTolMaterialReq Doc GTol_Label mod"
         "Values:"
         "\n  0 none"
         "\n  1 M"
         "\n  2 L",
  ...
  di.Add("XGetTolMaterialReq", "XGetTolMaterialReq Doc GTol_Label", __FILE__, getMatReq, g);

  di.Add("XSetTolZoneMod",
         "XSetTolZoneMod Doc GTol_Label mod"
         "Values:"
         "\n  0 none"
         "\n  1 P"
         "\n  2 NonUniform",
  ...
  di.Add("XGetTolZoneMod", "XGetTolZoneMod Doc GTol_Label", __FILE__, getZoneMod, g);

  di.Add("XSetTolZoneModValue",
         "XSetTolZoneModValue Doc GTol_Label val",
         __FILE__,
         setZoneModVal,
         g);

  di.Add("XGetTolZoneModValue", "XGetTolZoneModValue Doc GTol_Label", __FILE__, getZoneModVal, g);

  di.Add("XAddTolModifier",
         "XAddTolModifier Doc Tol_Label mod1 mod2 ..."
         "Values:\n"
         "\t  0 Any_Cross_Section\n"
         "\t  1 Common_Zone\n"
  ...
  di.Add("XGetTolModifier", "XGetTolModifier Doc Tol_Label", __FILE__, getTolModif, g);

  di.Add("XSetTolMaxValue", "XSetTolMaxValue Doc Dim_Label val", __FILE__, setTolMaxVal, g);

  di.Add("XGetTolMaxValue", "XGetTolMaxValue Doc Dim_Label val", __FILE__, getTolMaxVal, g);

  di.Add("XSetDimensionType",
         "XSetDimensionType Doc Dim_Label type"
         "Values:"
         "\t  0 type is absent\n"
  ...
  di.Add("XGetDimensionType", "XGetDimensionType Doc Dim_Label", __FILE__, getDimType, g);

  di.Add("XSetDimensionValue", "XSetDimensionValue Doc Dim_Label val", __FILE__, setDimVal, g);

  di.Add("XGetDimensionValue", "XGetDimensionValue Doc Dim_Label", __FILE__, getDimVal, g);

  di.Add("XSetDimensionQualifier",
         "XSetDimensionQualifier Doc Dim_Label val"
         "Values:"
         "\n  0 none"
         "\n  1 Min"
         "\n  2 Max"
  ...
  di.Add("XGetDimensionQualifier",
         "XGetDimensionQualifier Doc Dim_Label",
         __FILE__,
         getDimQalif,
         g);

  di.Add("XSetDimensionRange",
         "XSetDimensionRange Doc Dim_Label low_val up_val",
         __FILE__,
         setDimRange,
         g);

  di.Add("XGetDimensionRange", "XGetDimensionRange Doc Dim_Label", __FILE__, getDimRange, g);

  di.Add("XSetDimensionPlusMinusTol",
         "XSetDimensionPlusMinusTol Doc Dim_Label low_val up_val",
         __FILE__,
         setDimPlusMinusTol,
         g);

  di.Add("XGetDimensionPlusMinusTol",
         "XGetDimensionPlusMinusTol Doc Dim_Label",
         __FILE__,
         getDimPlusMinusTol,
         g);

  di.Add("XSetDimensionClassOfTol",
         "XSetDimensionClassOfTol Doc Dim_Label ishole[1/0] formVar grade"
         "Values of formVar:"
         "\t 1 a\n"
         "\t 2 b\n"
         "\t 3 c\n"
  ...
  di.Add("XGetDimensionClassOfTol",
         "XGetDimensionClassOfTol Doc Dim_Label",
         __FILE__,
         getDimClassTol,
         g);

  di.Add("XSetDimensionNbOfDecimalPlaces",
         "XSetDimensionNbOfDecimalPlaces Doc Dim_Label l_val r_val",
         __FILE__,
         setDimNbOfDecimalPlaces,
         g);

  di.Add("XGetDimensionNbOfDecimalPlaces",
         "XGetDimensionNbOfDecimalPlaces Doc Dim_Label",
         __FILE__,
         getDimNbOfDecimalPlaces,
         g);

  di.Add("XAddDimensionModifiers",
         "XAddDimensionModifiers Doc Dim_Label mod1 mod2 ..."
         "Values:"
         "\t 0 ControlledRadius\n"
         "\t 1 Square\n"
  ...
  di.Add("XGetDimensionModifiers",
         "XGetDimensionModifiers Doc Dim_Label",
         __FILE__,
         getDimModifier,
         g);

  di.Add("XSetDimensionPath",
         "XSetDimensionPath Doc Dim_Label path(edge)",
         __FILE__,
         addDimPath,
         g);

  di.Add("XSetDimensionPoints",
         "XSetDimensionPoints Doc Dim_Label v1 [v2]",
         __FILE__,
         addDimPoints,
         g);

  di.Add("XGetDimensionPoints", "XGetDimensionPoints Doc Dim_Label", __FILE__, getDimPoints, g);

  di.Add("XSetDimensionDir", "XSetDimensionDir Doc Dim_Label x y z", __FILE__, addDimDir, g);

  di.Add("XGetDimensionDir", "XGetDimensionDir Doc Dim_Label", __FILE__, getDimDir, g);

  di.Add("XAddDimensionDescr",
         "XAddDimensionDescr Doc Dim_Label Description [DescriptionName]\n"
  ...
  di.Add("XGetDimensionDescr",
         "XGetDimensionDescr Doc Dim_Label\n"
         "Return all descriptions of given Dimension.",
         __FILE__,
         getDimDescr,
         g);

  di.Add("XSetGDTPosition",
         "XSetGDTPosition Doc GDT_Label loc_x loc_y loc_z normal_x normal_y normal_z xdir_x xdir_y "
         "xdir_z"
  ...
  di.Add("XGetGDTPosition",
         "XGetGDTPosition Doc GDT_Label"
         "Returns text position and plane, parallel to which dimension is displayed",
         __FILE__,
         getGDTPosition,
         g);

  di.Add("XSetGDTPresentation",
         "XSetGDTPresentation Doc GDT_Label Shape Name"
         "Set presentation with given name for dimension",
         __FILE__,
         addGDTPresentation,
         g);

  di.Add("XGetGDTPresentation",
         "XGetGDTPresentation Doc GDT_Label Shape"
  ...
  di.Add("XGetGDTAffectedPlane",
         ...
         getGDTAffectedPlane,
         g);
  di.Add("XGetGDTSemanticName",
         "XGetGDTSemanticName Doc GDT_Label",
         __FILE__,
         getGDTSemanticName,
         g);

  di.Add("XSetGDTSemanticName",
         "XSetGDTSemanticName Doc GDT_Label Name"
         "Set semantic name",
         __FILE__,
         setGDTSemanticName,
         g);
