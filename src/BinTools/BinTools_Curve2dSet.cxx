...
Standard_Integer BinTools_Curve2dSet::Index(const Handle(Geom2d_Curve)& S) const
{
...
Standard_IStream& BinTools_Curve2dSet::ReadCurve2d(Standard_IStream& IS, Handle(Geom2d_Curve)& C)
{
  try
  {
    OCC_CATCH_SIGNALS
