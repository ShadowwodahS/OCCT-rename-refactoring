...
public:
  ...
  Standard_EXPORT ChFi2d_ChamferAPI(const TopoWire& theWire);

  //! A constructor accepting two linear edges.
  Standard_EXPORT ChFi2d_ChamferAPI(const TopoEdge& theEdge1, const TopoEdge& theEdge2);

  //! Initializes the class by a wire consisting of two libear edges.
  Standard_EXPORT void Init(const TopoWire& theWire);

  //! Initializes the class by two linear edges.
  Standard_EXPORT void Init(const TopoEdge& theEdge1, const TopoEdge& theEdge2);
  ...
  Standard_EXPORT TopoEdge Result(TopoEdge&        theEdge1,
                                     TopoEdge&        theEdge2,
...
private:
  ...
  Handle(GeomCurve3d) myCurve1, myCurve2;
