...
public:
  ...
  Standard_EXPORT static void Add(const SurfaceAdaptor& S, const Standard_Real Tol, Box2& B);
  ...
  //! Standard_Real Tol = ... ;
  //! AddSurface::Add ( S, Tol, B );
  Standard_EXPORT static void Add(const SurfaceAdaptor& S,
  ...
  Standard_EXPORT static void AddOptimal(const SurfaceAdaptor& S,
                                         const Standard_Real      Tol,
                                         Box2&                 B);
  ...
  Standard_EXPORT static void AddGenSurf(const SurfaceAdaptor& S,
                                         const Standard_Real      UMin,
                                         const Standard_Real      UMax,
                                         const Standard_Real      VMin,
                                         const Standard_Real      VMax,
