...
public:
  ...
  Standard_EXPORT GeometryData();

  Standard_EXPORT GeometryData(const GeometryData& Other);

  Standard_EXPORT void Assign(const GeometryData& Other);

  void operator=(const GeometryData& Other) { Assign(Other); }
