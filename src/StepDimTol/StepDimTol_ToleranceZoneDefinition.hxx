...
public:
  ...
  inline void SetBoundariesValue(const Standard_Integer              theNum,
                                 const Handle(StepRepr_ShapeAspect)& theItem)
  {
    myBoundaries->SetValue(theNum, theItem);
  }

  //! Returns field Zone
  inline Handle(StepDimTol_ToleranceZone) Zone() { return myZone; }
