                       ...
                       const char**     theArgs)
{
  ...
  if (ParseDimensionParams(theArgsNb,
                           theArgs,
                           3,
                           anAspect,
                           isPlaneCustom,
    ...
    case PrsDim_KOD_PLANEANGLE: {
      switch (aShapes.Extent())
      {
        ...
        case 2: {
          ...
          {
            aDim = new PrsDim_AngleDimension(TopoDS::Edge(aShape1->Shape()),
                                             TopoDS::Edge(aShape2->Shape()));
          }
          else
          {
                            ...
                            const char**     theArgs)
{
  ...
  switch (aKindOfRelation)
  {
    ...
    case PrsDim_KOR_EQUALDISTANCE: {
      ...
      aRelation = new PrsDim_EqualDistanceRelation(aSelectedShapes[0],
                                                   aSelectedShapes[1],
                                                   aSelectedShapes[2],
                                                   aSelectedShapes[3],
                                                   aMkPlane.Value());
