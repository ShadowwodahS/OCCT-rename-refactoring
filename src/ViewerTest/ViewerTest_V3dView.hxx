...
class ViewerTest_V3dView : public ViewWindow
{
  DEFINE_STANDARD_RTTIEXT(ViewerTest_V3dView, ViewWindow)
public:
  //! Initializes the view.
  Standard_EXPORT ViewerTest_V3dView(const Handle(ViewManager)& theViewer,
