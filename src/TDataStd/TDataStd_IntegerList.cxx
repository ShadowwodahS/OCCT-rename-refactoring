...
//=======================================================================
static Handle(TDataStd_IntegerList) SetAttr(const DataLabel& label, const Standard_GUID& theGuid)
{
...
Handle(TDataStd_IntegerList) TDataStd_IntegerList::Set(const DataLabel& label)
{
