...
gp_Lin2d::gp_Lin2d(const Standard_Real A, const Standard_Real B, const Standard_Real C)
{
  ...
  Standard_ConstructionError_Raise_if(Norm2 <= gp1::Resolution(), " ");
  const gp_Pnt2d P(-A * C / Norm2, -B * C / Norm2);
  const gp_Dir2d V(-B, A);

  //   gp_Pnt2d P;
  //   Standard_Real Norm = sqrt(A * A + B * B);
  //   Standard_ConstructionError_Raise_if (Norm <= gp1::Resolution(), " ");
  ...
  //   if (AA1 < 0) AA1 = - AA1;
  //   if (AA1 > gp1::Resolution()) P.SetCoord (-C1 / A1, 0.0);
