...
//! Defines Draw1 File Access Module for IGESDraw1 (specific parts)
...
public:
  ...
  //! Defines Case Numbers1 for Entities of IGESDraw1
  ...
  //! Reads own parameters from file for an Entity of IGESDraw1
