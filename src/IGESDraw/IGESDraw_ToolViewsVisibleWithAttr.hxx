...
public:
  ...
  Standard_EXPORT void ReadOwnParams(const Handle(IGESDraw_ViewsVisibleWithAttr)& ent,
                                     const Handle(IGESData_IGESReaderData)&       IR,
                                     IGESData_ParamReader&                        PR) const;

  //! Writes own parameters to IGESWriter
  Standard_EXPORT void WriteOwnParams(const Handle(IGESDraw_ViewsVisibleWithAttr)& ent,
  ...
  Standard_EXPORT void OwnShared(const Handle(IGESDraw_ViewsVisibleWithAttr)& ent,
                                 Interface_EntityIterator&                    iter) const;

  //! Lists the Entities shared by a ViewsVisible <ent>, from
  //! its specific (own) implied parameters : the Displayed Entities
  Standard_EXPORT void OwnImplied(const Handle(IGESDraw_ViewsVisibleWithAttr)& ent,
                                  Interface_EntityIterator&                    iter) const;
  ...
  Standard_EXPORT void OwnCheck(const Handle(IGESDraw_ViewsVisibleWithAttr)& ent,
                                const Interface_ShareTool&                   shares,
                                Handle(Interface_Check)&                     ach) const;

  //! Copies Specific Parameters shared not implied, i.e. all but
  //! the Displayed Entities
  Standard_EXPORT void OwnCopy(const Handle(IGESDraw_ViewsVisibleWithAttr)& entfrom,
  ...
  Standard_EXPORT void OwnRenew(const Handle(IGESDraw_ViewsVisibleWithAttr)& entfrom,
                                const Handle(IGESDraw_ViewsVisibleWithAttr)& entto,
  ...
  Standard_EXPORT void OwnDump(const Handle(IGESDraw_ViewsVisibleWithAttr)& ent,
  ...
  Standard_EXPORT Standard_Boolean
    OwnCorrect(const Handle(IGESDraw_ViewsVisibleWithAttr)& ent) const;
