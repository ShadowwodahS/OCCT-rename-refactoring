...
Handle(IGESData_IGESEntity) IGESDraw_NetworkSubfigureDef::Entity(const Standard_Integer Index) const
{
...
Handle(TCollection_HAsciiString) IGESDraw_NetworkSubfigureDef::Designator() const
{
...
Handle(IGESGraph_TextDisplayTemplate) IGESDraw_NetworkSubfigureDef::DesignatorTemplate() const
{
