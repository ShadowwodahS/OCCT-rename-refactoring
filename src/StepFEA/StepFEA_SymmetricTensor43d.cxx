...
Standard_Integer StepFEA_SymmetricTensor43d::CaseMem(const Handle(SelectMember)& ent) const
{
  if (ent.IsNull())
    return 0;
...
Handle(SelectMember) StepFEA_SymmetricTensor43d::NewMember() const
{
  // Handle(SelectMember) dummy;
  // return dummy;
