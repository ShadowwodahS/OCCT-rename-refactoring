...
public:
  ...
  Standard_EXPORT BRepOffsetAPI_ThruSections(const Standard_Boolean isSolid = Standard_False,
  ...
  Standard_EXPORT void Init(const Standard_Boolean isSolid = Standard_False,
                            const Standard_Boolean ruled   = Standard_False,
                            const Standard_Real    pres3d  = 1.0e-06);
  ...
  //! Use the Build function to construct the shape.
  Standard_EXPORT void AddVertex(const TopoVertex& aVertex);
  ...
  Standard_EXPORT TopoShape GeneratedFace(const TopoShape& Edge) const;
  ...
  const ShapeList& Wires() const { return myInputWires; }
...
private:
  ...
  ShapeList                   myInputWires; //!< List of input wires
