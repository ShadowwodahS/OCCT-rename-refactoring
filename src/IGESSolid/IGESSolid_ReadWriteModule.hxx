...
//! Defines Solid File Access Module for IGESSolid1 (specific parts)
...
public:
  ...
  //! Defines Case Numbers1 for Entities of IGESSolid1
  ...
  //! Reads own parameters from file for an Entity of IGESSolid1
