...
public:
  ...
  Standard_Integer FirstPoint() const { return myPoints[0]; }

  //! Returns the second point
  Standard_Integer SecondPoint() const { return myPoints[1]; }

  //! Returns the third point
  Standard_Integer ThirdPoint() const { return myPoints[2]; }

  //! Returns the first edge
  Standard_Integer FirstEdge() const { return myEdges[0]; }

  //! Returns the orientation of the first edge
  Standard_Integer FirstEdgeOrientation() const { return myEdgesOrientations[0]; }

  //! Returns the second edge
  Standard_Integer SecondEdge() const { return myEdges[1]; }

  //! Returns the orientation of the second edge
  Standard_Integer SecondEdgeOrientation() const { return myEdgesOrientations[1]; }

  //! Returns the third edge
  Standard_Integer ThirdEdge() const { return myEdges[2]; }

  //! Returns the orientation of the third edge
  Standard_Integer ThirdEdgeOrientation() const { return myEdgesOrientations[2]; }
  ...
  Standard_Boolean IsIntersectionPossible() const { return myIsIntersectionPossible; }

  //! Returns true if the triangle has interfered the other triangle
  Standard_Boolean HasIntersection() const { return myHasIntersection; }

  //! Returns the Degenerated flag
  Standard_Boolean IsDegenerated() const { return myIsDegenerated; }

  //! Sets the first point
  void SetFirstPoint(const Standard_Integer thePoint) { myPoints[0] = thePoint; }

  //! Sets the second point
  void SetSecondPoint(const Standard_Integer thePoint) { myPoints[1] = thePoint; }

  //! Sets the third point
  void SetThirdPoint(const Standard_Integer thePoint) { myPoints[2] = thePoint; }
  ...
  void SetIntersectionPossible(const Standard_Boolean theIP) { myIsIntersectionPossible = theIP; }

  //! Sets the flag of intersection
  void SetIntersection(const Standard_Boolean theInt) { myHasIntersection = theInt; }

  //! Sets the degenerated flag
  void SetDegenerated(const Standard_Boolean theDegFlag) { myIsDegenerated = theDegFlag; }
