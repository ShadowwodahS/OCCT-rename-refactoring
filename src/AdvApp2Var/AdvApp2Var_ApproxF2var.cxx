      ...
      for (ii = 1; ii <= i__3; ++ii)
      {
        ...
        for (kk = 1; kk <= i__4; ++kk)
        {
          ...
          div1 = fpntbv[kkp + ((jj << 1) - 1) * fpntbv_dim1]
                 - fpntbv[kkm + ((jj << 1) - 1) * fpntbv_dim1];
          sov2 = fpntbv[kkp + (jj << 1) * fpntbv_dim1] + fpntbv[kkm + (jj << 1) * fpntbv_dim1];
          div2 = fpntbv[kkp + (jj << 1) * fpntbv_dim1] - fpntbv[kkm + (jj << 1) * fpntbv_dim1];
          i__5 = nuroo;
          for (ll = 1; ll <= i__5; ++ll)
          {
            llp  = (*nbpntu + 1) / 2 + ll;
            ...
            diu1 = fpntbu[llp + ((ii << 1) - 1) * fpntbu_dim1]
                   - fpntbu[llm + ((ii << 1) - 1) * fpntbu_dim1];
            sou2 = fpntbu[llp + (ii << 1) * fpntbu_dim1] + fpntbu[llm + (ii << 1) * fpntbu_dim1];
            diu2 = fpntbu[llp + (ii << 1) * fpntbu_dim1] - fpntbu[llm + (ii << 1) * fpntbu_dim1];
            sosotb[ll + (kk + nd * sosotb_dim2) * sosotb_dim1] =
              sosotb[ll + (kk + nd * sosotb_dim2) * sosotb_dim1] - bid1 * sou1 * sov1
              - bid2 * sou2 * sov1 - bid3 * sou1 * sov2 - bid4 * sou2 * sov2;
            soditb[ll + (kk + nd * soditb_dim2) * soditb_dim1] =
              soditb[ll + (kk + nd * soditb_dim2) * soditb_dim1] - bid1 * sou1 * div1
              - bid2 * sou2 * div1 - bid3 * sou1 * div2 - bid4 * sou2 * div2;
            disotb[ll + (kk + nd * disotb_dim2) * disotb_dim1] =
              disotb[ll + (kk + nd * disotb_dim2) * disotb_dim1] - bid1 * diu1 * sov1
              - bid2 * diu2 * sov1 - bid3 * diu1 * sov2 - bid4 * diu2 * sov2;
        ...
        if (*nbpntu % 2 == 1)
        {
          ...
          for (kk = 1; kk <= i__4; ++kk)
          {
            ...
            sosotb[(kk + nd * sosotb_dim2) * sosotb_dim1] =
              sosotb[(kk + nd * sosotb_dim2) * sosotb_dim1] - bid1 * sou1 * sov1
              - bid2 * sou2 * sov1 - bid3 * sou1 * sov2 - bid4 * sou2 * sov2;
        ...
        if (*nbpntv % 2 == 1)
        {
          ...
          for (ll = 1; ll <= i__4; ++ll)
          {
            ...
            sou2 = fpntbu[llp + (ii << 1) * fpntbu_dim1] + fpntbu[llm + (ii << 1) * fpntbu_dim1];
            diu2 = fpntbu[llp + (ii << 1) * fpntbu_dim1] - fpntbu[llm + (ii << 1) * fpntbu_dim1];
            sosotb[ll + nd * sosotb_dim2 * sosotb_dim1] =
              sosotb[ll + nd * sosotb_dim2 * sosotb_dim1] - bid1 * sou1 * sov1 - bid2 * sou2 * sov1
        ...
        if (*nbpntu % 2 == 1 && *nbpntv % 2 == 1)
        {
          ...
          sov1 = fpntbv[nvroo + 1 + ((jj << 1) - 1) * fpntbv_dim1];
          sov2 = fpntbv[nvroo + 1 + (jj << 1) * fpntbv_dim1];
          sosotb[nd * sosotb_dim2 * sosotb_dim1] = sosotb[nd * sosotb_dim2 * sosotb_dim1]
                                                   - bid1 * sou1 * sov1 - bid2 * sou2 * sov1
                                                   - bid3 * sou1 * sov2 - bid4 * sou2 * sov2;
          diditb[nd * diditb_dim2 * diditb_dim1] = diditb[nd * diditb_dim2 * diditb_dim1]
                                                   - bid1 * sou1 * sov1 - bid2 * sou2 * sov1
                                                   - bid3 * sou1 * sov2 - bid4 * sou2 * sov2;
        }
  ...
  for (nd = 1; nd <= i__1; ++nd)
  {
    ...
    if (*nbpntv % 2 == 1)
    {
      ...
      for (ii = 1; ii <= i__2; ++ii)
      {
        ...
        {
          bid1 = sotbv1[kk + (nd + ii * sotbv1_dim2) * sotbv1_dim1]
                   * fpntab[nvroo + 1 + ((ii << 1) - 1) * fpntab_dim1]
                 + sotbv2[kk + (nd + ii * sotbv2_dim2) * sotbv2_dim1]
    ...
    if (*nbpntu % 2 == 1)
    {
      ...
      for (ii = 1; ii <= i__2; ++ii)
      {
        ...
        for (jj = 1; jj <= i__3; ++jj)
        {
          ...
          jjm = nvroo - jj + 1;
          bid1 =
            sotbv1[(nd + ii * sotbv1_dim2) * sotbv1_dim1]
              * (fpntab[jjp + ((ii << 1) - 1) * fpntab_dim1]
                 + fpntab[jjm + ((ii << 1) - 1) * fpntab_dim1])
  ...
  for (nd = 1; nd <= i__1; ++nd)
  {
    ...
    if (*nbpntu % 2 == 1)
    {
      ...
      for (ii = 1; ii <= i__2; ++ii)
      {
        ...
        {
          bid1 = sotbu1[jj + (nd + ii * sotbu1_dim2) * sotbu1_dim1]
                   * fpntab[nuroo + 1 + ((ii << 1) - 1) * fpntab_dim1]
                 + sotbu2[jj + (nd + ii * sotbu2_dim2) * sotbu2_dim1]
    ...
    if (*nbpntv % 2 == 1)
    {
      ...
      for (ii = 1; ii <= i__2; ++ii)
      {
        ...
        for (kk = 1; kk <= i__3; ++kk)
        {
          ...
          kkm = nuroo - kk + 1;
          bid1 =
            sotbu1[(nd + ii * sotbu1_dim2) * sotbu1_dim1]
              * (fpntab[kkp + ((ii << 1) - 1) * fpntab_dim1]
                 + fpntab[kkm + ((ii << 1) - 1) * fpntab_dim1])
    ...
    for (id = 1; id <= i__2; ++id)
    {
      ...
      for (iu = 1; iu <= i__3; ++iu)
      {
        ...
        sosotb[iu + (nvroo - iv + 1 + id * sosotb_dim2) * sosotb_dim1] =
          sosotb[iu + (nvroo - iv + 1 + id * sosotb_dim2) * sosotb_dim1] + up + um;
        disotb[iu + (nvroo - iv + 1 + id * disotb_dim2) * disotb_dim1] =
          disotb[iu + (nvroo - iv + 1 + id * disotb_dim2) * disotb_dim1] + up - um;
  ...
  if (*nbpntv % 2 != 0)
  {
    ...
    for (id = 1; id <= i__1; ++id)
    {
      ...
      for (iu = 1; iu <= i__2; ++iu)
      {
        ...
        um = fpntab[id + (nuroo - iu + 1) * fpntab_dim1];
        sosotb[iu + id * sosotb_dim2 * sosotb_dim1] =
  ...
  for (iv = 1; iv <= i__1; ++iv)
  {
    ...
    for (id = 1; id <= i__2; ++id)
    {
      ...
      for (iu = 1; iu <= i__3; ++iu)
      {
        up = fpntab[id + (iu + jdec) * fpntab_dim1];
        um = fpntab[id + (nuroo - iu + 1) * fpntab_dim1];
        sosotb[iu + (iv + id * sosotb_dim2) * sosotb_dim1] =
          sosotb[iu + (iv + id * sosotb_dim2) * sosotb_dim1] + up + um;
        disotb[iu + (iv + id * disotb_dim2) * disotb_dim1] =
          disotb[iu + (iv + id * disotb_dim2) * disotb_dim1] + up - um;
...
L1000:
  ...
  mma1fdi_(ndimen,
           ...
           ideriv,
           &wrkar_off[ipt1],
           &somtab[(ncb1 * somtab_dim2 + 1) * somtab_dim1],
           &diftab[(ncb1 * diftab_dim2 + 1) * diftab_dim1],
           &contr1[(ncb1 * contr1_dim2 + 1) * contr1_dim1 + 1],
           &contr2[(ncb1 * contr2_dim2 + 1) * contr2_dim1 + 1],
           iercod);
  if (*iercod > 0)
  {
    goto L9900;
  ...
  mma1fer_(ndimen,
           ...
           &epsapr[1],
           &wrkar_off[ipt1],
           &errmax[ncb1 * errmax_dim1 + 1],
           &errmoy[ncb1 * errmoy_dim1 + 1],
           &ncoeff[ncb1],
           &ier);
  if (ier > 0)
  {
    ...
    */
    ...
    for (ii = 0; ii <= i__1; ++ii)
    {
      mma1noc_(uv11,
               ndimen,
               &ii,
               &contr1[(ii + 1 + ncb1 * contr1_dim2) * contr1_dim1 + 1],
               uvpav,
               isofav,
               ideriv,
               &contr1[(ii + 1 + ncb1 * contr1_dim2) * contr1_dim1 + 1]);
                                     ...
                                     integer*       iercod)
{
  ...
  *iercod = 0;
  ...
  if (*nbpnts != 8 && *nbpnts != 10 && *nbpnts != 15 && *nbpnts != 20 && *nbpnts != 25
      && *nbpnts != 30 && *nbpnts != 40 && *nbpnts != 50 && *nbpnts != 61)
  {
    goto L9100;
  }
