...
typedef NCollection_DoubleMap<Standard_Integer, DataLabel> TFunction_DoubleMapOfIntegerLabel;
typedef NCollection_DoubleMap<Standard_Integer, DataLabel>::Iterator
