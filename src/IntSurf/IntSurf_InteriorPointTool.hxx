...
public:
  ...
  static Point3d Value3d(const InteriorPoint& PStart);

  //! Returns the <U,V> parameters which are associated
  //! with <P>
  //! it's the parameters which start the marching algorithm
  static void Value2d(const InteriorPoint& PStart, Standard_Real& U, Standard_Real& V);

  //! returns the tangent at the intersection in 3d space
  //! associated to <P>
  static Vector3d Direction3d(const InteriorPoint& PStart);
  ...
  static gp_Dir2d Direction2d(const InteriorPoint& PStart);
